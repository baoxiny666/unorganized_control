...
var opts=$(_926).datagrid("options");
...
var _928=opts.rowStyler;
opts.rowStyler=function(){
};
var _929=$.data(_926,"datagrid").dc.body2;
_929.html(this.renderTable(_926,0,[{}],false));
_929.find("tbody *").css({height:1,borderColor:"transparent",background:"transparent"});
var tr=_929.find(".datagrid-row");
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",resizeEdge:5,autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",emptyMsg:"",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollOnSelect:true,scrollbarSize:18,rownumberWidth:30,editorHeight:31,headerEvents:{mouseover:_76b(true),mouseout:_76b(false),click:_76f,dblclick:_774,contextmenu:_777},rowEvents:{mouseover:_779(true),mouseout:_779(false),click:_780,dblclick:_78a,contextmenu:_78e},rowStyler:function(_92a,_92b){
},loader:function(_92c,_92d,_92e){
var opts=$(this).datagrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_92c,dataType:"json",success:function(data){
_92d(data);
},error:function(){
_92e.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},editors:_89a,finder:{getTr:function(_92f,_930,type,_931){
type=type||"body";
_931=_931||0;
var _932=$.data(_92f,"datagrid");
var dc=_932.dc;
var opts=_932.options;
if(_931==0){
var tr1=opts.finder.getTr(_92f,_930,type,1);
var tr2=opts.finder.getTr(_92f,_930,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+_932.rowIdPrefix+"-"+_931+"-"+_930);
if(!tr.length){
tr=(_931==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index="+_930+"]");
}
return tr;
}else{
if(type=="footer"){
return (_931==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index="+_930+"]");
}else{
if(type=="selected"){
return (_931==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_931==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_931==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-checked");
}else{
if(type=="editing"){
return (_931==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-editing");
}else{
if(type=="last"){
return (_931==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]:last");
}else{
if(type=="allbody"){
return (_931==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]");
}else{
if(type=="allfooter"){
return (_931==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index]");
}
}
}
}
...
},getRow:function(_933,p){
var _934=(typeof p=="object")?p.attr("datagrid-row-index"):p;
return $.data(_933,"datagrid").data.rows[parseInt(_934)];
},getRows:function(_935){
return $(_935).datagrid("getRows");
}},view:_8e3,onBeforeLoad:function(_936){
},onLoadSuccess:function(){
},onLoadError:function(){
},onClickRow:function(_937,_938){
},onDblClickRow:function(_939,_93a){
},onClickCell:function(_93b,_93c,_93d){
},onDblClickCell:function(_93e,_93f,_940){
},onBeforeSortColumn:function(sort,_941){
},onSortColumn:function(sort,_942){
},onResizeColumn:function(_943,_944){
},onBeforeSelect:function(_945,_946){
},onSelect:function(_947,_948){
},onBeforeUnselect:function(_949,_94a){
},onUnselect:function(_94b,_94c){
},onSelectAll:function(rows){
},onUnselectAll:function(rows){
},onBeforeCheck:function(_94d,_94e){
},onCheck:function(_94f,_950){
},onBeforeUncheck:function(_951,_952){
},onUncheck:function(_953,_954){
},onCheckAll:function(rows){
},onUncheckAll:function(rows){
},onBeforeEdit:function(_955,_956){
},onBeginEdit:function(_957,_958){
},onEndEdit:function(_959,_95a,_95b){
},onAfterEdit:function(_95c,_95d,_95e){
},onCancelEdit:function(_95f,_960){
},onHeaderContextMenu:function(e,_961){
},onRowContextMenu:function(e,_962,_963){
}});
})(jQuery);
(function($){
var _964;
...
function _966(_967){
var _968=$.data(_967,"propertygrid");
var opts=$.data(_967,"propertygrid").options;
$(_967).datagrid($.extend({},opts,{cls:"propertygrid",view:(opts.showGroup?opts.groupView:opts.view),onBeforeEdit:function(_969,row){
if(opts.onBeforeEdit.call(_967,_969,row)==false){
return false;
}
var dg=$(this);
var row=dg.datagrid("getRows")[_969];
var col=dg.datagrid("getColumnOption","value");
col.editor=row.editor;
},onClickCell:function(_96a,_96b,_96c){
if(_964!=this){
_965(_964);
_964=this;
}
if(opts.editIndex!=_96a){
_965(_964);
$(this).datagrid("beginEdit",_96a);
var ed=$(this).datagrid("getEditor",{index:_96a,field:_96b});
if(!ed){
ed=$(this).datagrid("getEditor",{index:_96a,field:"value"});
}
if(ed){
var t=$(ed.target);
var _96d=t.data("textbox")?t.textbox("textbox"):t;
_96d.focus();
opts.editIndex=_96a;
}
}
opts.onClickCell.call(_967,_96a,_96b,_96c);
},loadFilter:function(data){
_965(this);
...
opts.finder.getTr(_96e,null,"editing").each(function(){
var _96f=parseInt($(this).attr("datagrid-row-index"));
if(t.datagrid("validateRow",_96f)){
t.datagrid("endEdit",_96f);
}else{
t.datagrid("cancelEdit",_96f);
}
});
opts.editIndex=undefined;
};
$.fn.propertygrid=function(_970,_971){
if(typeof _970=="string"){
var _972=$.fn.propertygrid.methods[_970];
if(_972){
return _972(this,_971);
}else{
return this.datagrid(_970,_971);
}
}
_970=_970||{};
return this.each(function(){
var _973=$.data(this,"propertygrid");
if(_973){
$.extend(_973.options,_970);
}else{
var opts=$.extend({},$.fn.propertygrid.defaults,$.fn.propertygrid.parseOptions(this),_970);
opts.frozenColumns=$.extend(true,[],opts.frozenColumns);
opts.columns=$.extend(true,[],opts.columns);
...
$.fn.propertygrid.parseOptions=function(_974){
return $.extend({},$.fn.datagrid.parseOptions(_974),$.parser.parseOptions(_974,[{showGroup:"boolean"}]));
};
var _975=$.extend({},$.fn.datagrid.defaults.view,{render:function(_976,_977,_978){
var _979=[];
var _97a=this.groups;
for(var i=0;i<_97a.length;i++){
_979.push(this.renderGroup.call(this,_976,i,_97a[i],_978));
}
$(_977).html(_979.join(""));
},renderGroup:function(_97b,_97c,_97d,_97e){
var _97f=$.data(_97b,"datagrid");
var opts=_97f.options;
var _980=$(_97b).datagrid("getColumnFields",_97e);
var _981=opts.frozenColumns&&opts.frozenColumns.length;
if(_97e){
if(!(opts.rownumbers||_981)){
return "";
}
}
var _982=[];
var css=opts.groupStyler.call(_97b,_97d.value,_97d.rows);
var cs=_983(css,"datagrid-group");
_982.push("<div group-index="+_97c+" "+cs+">");
if((_97e&&(opts.rownumbers||opts.frozenColumns.length))||(!_97e&&!(opts.rownumbers||opts.frozenColumns.length))){
_982.push("<span class=\"datagrid-group-expander\">");
_982.push("<span class=\"datagrid-row-expander datagrid-row-collapse\">&nbsp;</span>");
_982.push("</span>");
}
if((_97e&&_981)||(!_97e)){
_982.push("<span class=\"datagrid-group-title\">");
_982.push(opts.groupFormatter.call(_97b,_97d.value,_97d.rows));
_982.push("</span>");
}
_982.push("</div>");
_982.push("<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>");
var _984=_97d.startIndex;
for(var j=0;j<_97d.rows.length;j++){
var css=opts.rowStyler?opts.rowStyler.call(_97b,_984,_97d.rows[j]):"";
var _985="";
var _986="";
if(typeof css=="string"){
_986=css;
...
var cls="class=\"datagrid-row "+(_984%2&&opts.striped?"datagrid-row-alt ":" ")+_985+"\"";
var _987=_986?"style=\""+_986+"\"":"";
var _988=_97f.rowIdPrefix+"-"+(_97e?1:2)+"-"+_984;
_982.push("<tr id=\""+_988+"\" datagrid-row-index=\""+_984+"\" "+cls+" "+_987+">");
_982.push(this.renderRow.call(this,_97b,_980,_97e,_984,_97d.rows[j]));
_982.push("</tr>");
_984++;
}
_982.push("</tbody></table>");
return _982.join("");
function _983(css,cls){
var _989="";
var _98a="";
if(typeof css=="string"){
_98a=css;
...
return "class=\""+cls+(_989?" "+_989:"")+"\" "+"style=\""+_98a+"\"";
};
},bindEvents:function(_98b){
var _98c=$.data(_98b,"datagrid");
var dc=_98c.dc;
var body=dc.body1.add(dc.body2);
var _98d=($.data(body[0],"events")||$._data(body[0],"events")).click[0].handler;
body.unbind("click").bind("click",function(e){
var tt=$(e.target);
var _98e=tt.closest("span.datagrid-row-expander");
if(_98e.length){
var _98f=_98e.closest("div.datagrid-group").attr("group-index");
if(_98e.hasClass("datagrid-row-collapse")){
$(_98b).datagrid("collapseGroup",_98f);
}else{
$(_98b).datagrid("expandGroup",_98f);
}
}else{
_98d(e);
}
...
},onBeforeRender:function(_990,rows){
var _991=$.data(_990,"datagrid");
var opts=_991.options;
_992();
var _993=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _994=_995(row[opts.groupField]);
if(!_994){
_994={value:row[opts.groupField],rows:[row]};
_993.push(_994);
}else{
_994.rows.push(row);
}
...
var _994=_993[i];
_994.startIndex=_996;
_996+=_994.rows.length;
_997=_997.concat(_994.rows);
}
_991.data.rows=_997;
this.groups=_993;
var that=this;
setTimeout(function(){
that.bindEvents(_990);
},0);
function _995(_998){
for(var i=0;i<_993.length;i++){
var _999=_993[i];
...
},onAfterRender:function(_99a){
$.fn.datagrid.defaults.view.onAfterRender.call(this,_99a);
var view=this;
var _99b=$.data(_99a,"datagrid");
var opts=_99b.options;
if(!_99b.onResizeColumn){
_99b.onResizeColumn=opts.onResizeColumn;
}
if(!_99b.onResize){
_99b.onResize=opts.onResize;
}
opts.onResizeColumn=function(_99c,_99d){
view.resizeGroup(_99a);
_99b.onResizeColumn.call(_99a,_99c,_99d);
};
opts.onResize=function(_99e,_99f){
view.resizeGroup(_99a);
_99b.onResize.call($(_99a).datagrid("getPanel")[0],_99e,_99f);
};
view.resizeGroup(_99a);
}});
$.extend($.fn.datagrid.methods,{groups:function(jq){
return jq.datagrid("options").view.groups;
},expandGroup:function(jq,_9a0){
return jq.each(function(){
var opts=$(this).datagrid("options");
var view=$.data(this,"datagrid").dc.view;
var _9a1=view.find(_9a0!=undefined?"div.datagrid-group[group-index=\""+_9a0+"\"]":"div.datagrid-group");
var _9a2=_9a1.find("span.datagrid-row-expander");
if(_9a2.hasClass("datagrid-row-expand")){
_9a2.removeClass("datagrid-row-expand").addClass("datagrid-row-collapse");
_9a1.next("table").show();
}
$(this).datagrid("fixRowHeight");
if(opts.onExpandGroup){
opts.onExpandGroup.call(this,_9a0);
}
});
},collapseGroup:function(jq,_9a3){
return jq.each(function(){
var opts=$(this).datagrid("options");
var view=$.data(this,"datagrid").dc.view;
...
if(_9a5.hasClass("datagrid-row-collapse")){
_9a5.removeClass("datagrid-row-collapse").addClass("datagrid-row-expand");
_9a4.next("table").hide();
}
$(this).datagrid("fixRowHeight");
if(opts.onCollapseGroup){
opts.onCollapseGroup.call(this,_9a3);
}
});
},scrollToGroup:function(jq,_9a6){
return jq.each(function(){
var _9a7=$.data(this,"datagrid");
var dc=_9a7.dc;
var grow=dc.body2.children("div.datagrid-group[group-index=\""+_9a6+"\"]");
if(grow.length){
var _9a8=grow.outerHeight();
var _9a9=dc.view2.children("div.datagrid-header")._outerHeight();
var _9aa=dc.body2.outerHeight(true)-dc.body2.outerHeight();
var top=grow.position().top-_9a9-_9aa;
if(top<0){
dc.body2.scrollTop(dc.body2.scrollTop()+top);
}else{
if(top+_9a8>dc.body2.height()-18){
dc.body2.scrollTop(dc.body2.scrollTop()+top+_9a8-dc.body2.height()+18);
}
}
}
});
}});
$.extend(_975,{refreshGroupTitle:function(_9ab,_9ac){
var _9ad=$.data(_9ab,"datagrid");
var opts=_9ad.options;
var dc=_9ad.dc;
var _9ae=this.groups[_9ac];
var span=dc.body1.add(dc.body2).children("div.datagrid-group[group-index="+_9ac+"]").find("span.datagrid-group-title");
span.html(opts.groupFormatter.call(_9ab,_9ae.value,_9ae.rows));
},resizeGroup:function(_9af,_9b0){
var _9b1=$.data(_9af,"datagrid");
var dc=_9b1.dc;
var ht=dc.header2.find("table");
var fr=ht.find("tr.datagrid-filter-row").hide();
var ww=dc.body2.children("table.datagrid-btable:first").width();
if(_9b0==undefined){
var _9b2=dc.body2.children("div.datagrid-group");
}else{
var _9b2=dc.body2.children("div.datagrid-group[group-index="+_9b0+"]");
}
_9b2._outerWidth(ww);
var opts=_9b1.options;
if(opts.frozenColumns&&opts.frozenColumns.length){
var _9b3=dc.view1.width()-opts.expanderWidth;
var _9b4=dc.view1.css("direction").toLowerCase()=="rtl";
_9b2.find(".datagrid-group-title").css(_9b4?"right":"left",-_9b3+"px");
}
if(fr.length){
...
},insertRow:function(_9b5,_9b6,row){
var _9b7=$.data(_9b5,"datagrid");
var opts=_9b7.options;
var dc=_9b7.dc;
var _9b8=null;
var _9b9;
if(!_9b7.data.rows.length){
$(_9b5).datagrid("loadData",[row]);
return;
}
...
if(_9b8){
if(_9b6==undefined||_9b6==null){
_9b6=_9b7.data.rows.length;
}
if(_9b6<_9b8.startIndex){
_9b6=_9b8.startIndex;
}else{
if(_9b6>_9b8.startIndex+_9b8.rows.length){
_9b6=_9b8.startIndex+_9b8.rows.length;
}
}
$.fn.datagrid.defaults.view.insertRow.call(this,_9b5,_9b6,row);
if(_9b6>=_9b8.startIndex+_9b8.rows.length){
_9ba(_9b6,true);
_9ba(_9b6,false);
}
_9b8.rows.splice(_9b6-_9b8.startIndex,0,row);
}else{
_9b8={value:row[opts.groupField],rows:[row],startIndex:_9b7.data.rows.length};
_9b9=this.groups.length;
dc.body1.append(this.renderGroup.call(this,_9b5,_9b9,_9b8,true));
dc.body2.append(this.renderGroup.call(this,_9b5,_9b9,_9b8,false));
this.groups.push(_9b8);
_9b7.data.rows.push(row);
}
this.setGroupIndex(_9b5);
this.refreshGroupTitle(_9b5,_9b9);
this.resizeGroup(_9b5);
function _9ba(_9bb,_9bc){
var _9bd=_9bc?1:2;
var _9be=opts.finder.getTr(_9b5,_9bb-1,"body",_9bd);
var tr=opts.finder.getTr(_9b5,_9bb,"body",_9bd);
tr.insertAfter(_9be);
};
},updateRow:function(_9bf,_9c0,row){
var opts=$.data(_9bf,"datagrid").options;
$.fn.datagrid.defaults.view.updateRow.call(this,_9bf,_9c0,row);
var tb=opts.finder.getTr(_9bf,_9c0,"body",2).closest("table.datagrid-btable");
var _9c1=parseInt(tb.prev().attr("group-index"));
this.refreshGroupTitle(_9bf,_9c1);
},deleteRow:function(_9c2,_9c3){
var _9c4=$.data(_9c2,"datagrid");
var opts=_9c4.options;
var dc=_9c4.dc;
var body=dc.body1.add(dc.body2);
var tb=opts.finder.getTr(_9c2,_9c3,"body",2).closest("table.datagrid-btable");
var _9c5=parseInt(tb.prev().attr("group-index"));
$.fn.datagrid.defaults.view.deleteRow.call(this,_9c2,_9c3);
var _9c6=this.groups[_9c5];
if(_9c6.rows.length>1){
_9c6.rows.splice(_9c3-_9c6.startIndex,1);
this.refreshGroupTitle(_9c2,_9c5);
}else{
body.children("div.datagrid-group[group-index="+_9c5+"]").remove();
for(var i=_9c5+1;i<this.groups.length;i++){
body.children("div.datagrid-group[group-index="+i+"]").attr("group-index",i-1);
}
this.groups.splice(_9c5,1);
}
this.setGroupIndex(_9c2);
},setGroupIndex:function(_9c7){
var _9c8=0;
for(var i=0;i<this.groups.length;i++){
var _9c9=this.groups[i];
_9c9.startIndex=_9c8;
_9c8+=_9c9.rows.length;
}
}});
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{groupHeight:28,expanderWidth:20,singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:20,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupView:_975,groupField:"group",groupStyler:function(_9ca,rows){
return "";
},groupFormatter:function(_9cb,rows){
return _9cb;
}});
})(jQuery);
(function($){
function _9cc(_9cd){
var _9ce=$.data(_9cd,"treegrid");
var opts=_9ce.options;
$(_9cd).datagrid($.extend({},opts,{url:null,data:null,loader:function(){
return false;
},onBeforeLoad:function(){
return false;
},onLoadSuccess:function(){
},onResizeColumn:function(_9cf,_9d0){
_9dd(_9cd);
opts.onResizeColumn.call(_9cd,_9cf,_9d0);
},onBeforeSortColumn:function(sort,_9d1){
if(opts.onBeforeSortColumn.call(_9cd,sort,_9d1)==false){
return false;
}
},onSortColumn:function(sort,_9d2){
opts.sortName=sort;
opts.sortOrder=_9d2;
if(opts.remoteSort){
_9dc(_9cd);
}else{
var data=$(_9cd).treegrid("getData");
_a0b(_9cd,null,data);
}
opts.onSortColumn.call(_9cd,sort,_9d2);
},onClickCell:function(_9d3,_9d4){
opts.onClickCell.call(_9cd,_9d4,find(_9cd,_9d3));
},onDblClickCell:function(_9d5,_9d6){
opts.onDblClickCell.call(_9cd,_9d6,find(_9cd,_9d5));
},onRowContextMenu:function(e,_9d7){
opts.onContextMenu.call(_9cd,e,find(_9cd,_9d7));
}}));
var _9d8=$.data(_9cd,"datagrid").options;
opts.columns=_9d8.columns;
opts.frozenColumns=_9d8.frozenColumns;
_9ce.dc=$.data(_9cd,"datagrid").dc;
if(opts.pagination){
var _9d9=$(_9cd).datagrid("getPager");
_9d9.pagination({total:0,pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_9da,_9db){
opts.pageNumber=_9da||1;
opts.pageSize=_9db;
_9d9.pagination("refresh",{pageNumber:_9da,pageSize:_9db});
_9dc(_9cd);
}});
opts.pageSize=_9d9.pagination("options").pageSize;
}
};
function _9dd(_9de,_9df){
var opts=$.data(_9de,"datagrid").options;
var dc=$.data(_9de,"datagrid").dc;
if(!dc.body1.is(":empty")&&(!opts.nowrap||opts.autoRowHeight)){
if(_9df!=undefined){
var _9e0=_9e1(_9de,_9df);
for(var i=0;i<_9e0.length;i++){
_9e2(_9e0[i][opts.idField]);
}
}
}
$(_9de).datagrid("fixRowHeight",_9df);
function _9e2(_9e3){
var tr1=opts.finder.getTr(_9de,_9e3,"body",1);
var tr2=opts.finder.getTr(_9de,_9e3,"body",2);
tr1.css("height","");
tr2.css("height","");
var _9e4=Math.max(tr1.height(),tr2.height());
tr1.css("height",_9e4);
tr2.css("height",_9e4);
};
};
...
function _9e7(_9e8){
return function(e){
$.fn.datagrid.defaults.rowEvents[_9e8?"mouseover":"mouseout"](e);
var tt=$(e.target);
var fn=_9e8?"addClass":"removeClass";
if(tt.hasClass("tree-hit")){
...
var opts=$(_9eb).datagrid("options");
if(!tt.parent().hasClass("datagrid-cell-check")&&!opts.singleSelect&&e.shiftKey){
var rows=$(_9eb).treegrid("getChildren");
var idx1=$.easyui.indexOfArray(rows,opts.idField,opts.lastSelectedIndex);
var idx2=$.easyui.indexOfArray(rows,opts.idField,_9ea);
var from=Math.min(Math.max(idx1,0),idx2);
var to=Math.max(idx1,idx2);
var row=rows[idx2];
var td=tt.closest("td[field]",tr);
if(td.length){
var _9ef=td.attr("field");
opts.onClickCell.call(_9eb,_9ea,_9ef,row[_9ef]);
}
$(_9eb).treegrid("clearSelections");
for(var i=from;i<=to;i++){
$(_9eb).treegrid("selectRow",rows[i][opts.idField]);
}
opts.onClickRow.call(_9eb,row);
}else{
...
function _9ee(_9f0,_9f1,_9f2,_9f3){
var _9f4=$.data(_9f0,"treegrid");
var _9f5=_9f4.checkedRows;
var opts=_9f4.options;
if(!opts.checkbox){
return;
}
var row=find(_9f0,_9f1);
if(!row.checkState){
return;
}
var tr=opts.finder.getTr(_9f0,_9f1);
...
if(!_9f3){
if(opts.onBeforeCheckNode.call(_9f0,row,_9f2)==false){
return;
}
}
if(opts.cascadeCheck){
...
_9f8(_9f0,row,_9f2?"1":"0");
}
if(!_9f3){
opts.onCheckNode.call(_9f0,row,_9f2);
}
};
function _9f8(_9f9,row,flag){
var _9fa=$.data(_9f9,"treegrid");
var _9fb=_9fa.checkedRows;
var opts=_9fa.options;
if(!row.checkState||flag==undefined){
return;
}
var tr=opts.finder.getTr(_9f9,row[opts.idField]);
var ck=tr.find(".tree-checkbox");
if(!ck.length){
return;
}
...
ck.addClass("tree-checkbox"+flag);
if(flag==0){
$.easyui.removeArrayItem(_9fb,opts.idField,row[opts.idField]);
}else{
$.easyui.addArrayItem(_9fb,opts.idField,row);
}
};
function _9f6(_9fc,row,_9fd){
var flag=_9fd?1:0;
_9f8(_9fc,row,flag);
...
function _9f7(_9fe,row){
var opts=$.data(_9fe,"treegrid").options;
var prow=_9ff(_9fe,row[opts.idField]);
if(prow){
_9f8(_9fe,prow,_a00(prow));
_9f7(_9fe,prow);
}
};
function _a00(row){
...
var opts=$.data(_a02,"treegrid").options;
if(!opts.checkbox){
return;
}
var row=find(_a02,_a03);
var tr=opts.finder.getTr(_a02,_a03);
var ck=tr.find(".tree-checkbox");
if(opts.view.hasCheckbox(_a02,row)){
if(!ck.length){
row.checkState=row.checkState||"unchecked";
$("<span class=\"tree-checkbox\"></span>").insertBefore(tr.find(".tree-title"));
}
if(row.checkState=="checked"){
_9ee(_a02,_a03,true,true);
}else{
if(row.checkState=="unchecked"){
_9ee(_a02,_a03,false,true);
}else{
var flag=_a00(row);
if(flag===0){
_9ee(_a02,_a03,false,true);
...
var tr1=opts.finder.getTr(_a05,_a06,"body",1);
var tr2=opts.finder.getTr(_a05,_a06,"body",2);
var _a07=$(_a05).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _a08=$(_a05).datagrid("getColumnFields",false).length;
_a09(tr1,_a07);
_a09(tr2,_a08);
function _a09(tr,_a0a){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_a0a+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _a0b(_a0c,_a0d,data,_a0e,_a0f){
var _a10=$.data(_a0c,"treegrid");
var opts=_a10.options;
var dc=_a10.dc;
data=opts.loadFilter.call(_a0c,data,_a0d);
var node=find(_a0c,_a0d);
if(node){
var _a11=opts.finder.getTr(_a0c,_a0d,"body",1);
var _a12=opts.finder.getTr(_a0c,_a0d,"body",2);
var cc1=_a11.next("tr.treegrid-tr-tree").children("td").children("div");
var cc2=_a12.next("tr.treegrid-tr-tree").children("td").children("div");
if(!_a0e){
node.children=[];
}
}else{
...
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_a0c,_a0d,data);
}
opts.view.render.call(opts.view,_a0c,cc1,true);
opts.view.render.call(opts.view,_a0c,cc2,false);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_a0c,dc.footer1,true);
opts.view.renderFooter.call(opts.view,_a0c,dc.footer2,false);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_a0c);
}
if(!_a0d&&opts.pagination){
var _a13=$.data(_a0c,"treegrid").total;
var _a14=$(_a0c).datagrid("getPager");
var _a15=_a14.pagination("options");
if(_a15.total!=data.total){
_a14.pagination("refresh",{pageNumber:opts.pageNumber,total:data.total});
if(opts.pageNumber!=_a15.pageNumber&&_a15.pageNumber>0){
opts.pageNumber=_a15.pageNumber;
_9dc(_a0c);
}
}
}
_9dd(_a0c);
_9e5(_a0c);
$(_a0c).treegrid("showLines");
$(_a0c).treegrid("setSelectionState");
$(_a0c).treegrid("autoSizeColumn");
if(!_a0f){
opts.onLoadSuccess.call(_a0c,node,data);
}
};
function _9dc(_a16,_a17,_a18,_a19,_a1a){
var opts=$.data(_a16,"treegrid").options;
var body=$(_a16).datagrid("getPanel").find("div.datagrid-body");
if(_a17==undefined&&opts.queryParams){
opts.queryParams.id=undefined;
}
if(_a18){
opts.queryParams=_a18;
}
var _a1b=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_a1b,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_a1b,{sort:opts.sortName,order:opts.sortOrder});
}
var row=find(_a16,_a17);
if(opts.onBeforeLoad.call(_a16,row,_a1b)==false){
return;
}
var _a1c=body.find("tr[node-id=\""+_a17+"\"] span.tree-folder");
_a1c.addClass("tree-loading");
$(_a16).treegrid("loading");
var _a1d=opts.loader.call(_a16,_a1b,function(data){
_a1c.removeClass("tree-loading");
$(_a16).treegrid("loaded");
_a0b(_a16,_a17,data,_a19);
if(_a1a){
_a1a();
}
},function(){
_a1c.removeClass("tree-loading");
$(_a16).treegrid("loaded");
opts.onLoadError.apply(_a16,arguments);
if(_a1a){
_a1a();
}
});
...
function _a1e(_a1f){
var _a20=_a21(_a1f);
return _a20.length?_a20[0]:null;
};
function _a21(_a22){
return $.data(_a22,"treegrid").data;
};
function _9ff(_a23,_a24){
var row=find(_a23,_a24);
if(row._parentId){
return find(_a23,row._parentId);
}else{
return null;
}
};
function _9e1(_a25,_a26){
var data=$.data(_a25,"treegrid").data;
if(_a26){
var _a27=find(_a25,_a26);
data=_a27?(_a27.children||[]):[];
}
var _a28=[];
$.easyui.forEach(data,true,function(node){
_a28.push(node);
...
function find(_a2c,_a2d){
var _a2e=$.data(_a2c,"treegrid");
var opts=_a2e.options;
var _a2f=null;
$.easyui.forEach(_a2e.data,true,function(node){
if(node[opts.idField]==_a2d){
_a2f=node;
return false;
}
});
...
if(opts.onBeforeCollapse.call(_a31,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
$(_a31).treegrid("autoSizeColumn");
_9dd(_a31,_a32);
opts.onCollapse.call(_a31,row);
});
}else{
cc.hide();
$(_a31).treegrid("autoSizeColumn");
...
if(opts.onBeforeExpand.call(_a34,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _a36=tr.next("tr.treegrid-tr-tree");
if(_a36.length){
var cc=_a36.children("td").children("div");
_a37(cc);
}else{
_a04(_a34,row[opts.idField]);
var _a36=tr.next("tr.treegrid-tr-tree");
var cc=_a36.children("td").children("div");
cc.hide();
var _a38=$.extend({},opts.queryParams||{});
_a38.id=row[opts.idField];
_9dc(_a34,row[opts.idField],_a38,true,function(){
if(cc.is(":empty")){
_a36.remove();
}else{
_a37(cc);
...
function _9ed(_a39,_a3a){
var opts=$.data(_a39,"treegrid").options;
var tr=opts.finder.getTr(_a39,_a3a);
var hit=tr.find("span.tree-hit");
if(hit.hasClass("tree-expanded")){
_a30(_a39,_a3a);
}else{
...
var _a3e=_9e1(_a3c,_a3d);
if(_a3d){
_a3e.unshift(find(_a3c,_a3d));
}
for(var i=0;i<_a3e.length;i++){
_a30(_a3c,_a3e[i][opts.idField]);
}
};
function _a3f(_a40,_a41){
var opts=$.data(_a40,"treegrid").options;
var _a42=_9e1(_a40,_a41);
if(_a41){
_a42.unshift(find(_a40,_a41));
}
for(var i=0;i<_a42.length;i++){
_a33(_a40,_a42[i][opts.idField]);
}
};
function _a43(_a44,_a45){
var opts=$.data(_a44,"treegrid").options;
var ids=[];
var p=_9ff(_a44,_a45);
while(p){
...
if(_a48.parent){
var tr=opts.finder.getTr(_a47,_a48.parent);
if(tr.next("tr.treegrid-tr-tree").length==0){
_a04(_a47,_a48.parent);
}
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
var _a4a=cell.children("span.tree-icon");
if(_a4a.hasClass("tree-file")){
_a4a.removeClass("tree-file").addClass("tree-folder tree-folder-open");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_a4a);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_a0b(_a47,_a48.parent,_a48.data,_a49.data.length>0,true);
};
function _a4b(_a4c,_a4d){
var ref=_a4d.before||_a4d.after;
var opts=$.data(_a4c,"treegrid").options;
var _a4e=_9ff(_a4c,ref);
_a46(_a4c,{parent:(_a4e?_a4e[opts.idField]:null),data:[_a4d.data]});
var _a4f=_a4e?_a4e.children:$(_a4c).treegrid("getRoots");
for(var i=0;i<_a4f.length;i++){
if(_a4f[i][opts.idField]==ref){
var _a50=_a4f[_a4f.length-1];
_a4f.splice(_a4d.before?i:(i+1),0,_a50);
_a4f.splice(_a4f.length-1,1);
break;
}
}
_a51(true);
_a51(false);
_9e5(_a4c);
$(_a4c).treegrid("showLines");
function _a51(_a52){
var _a53=_a52?1:2;
var tr=opts.finder.getTr(_a4c,_a4d.data[opts.idField],"body",_a53);
var _a54=tr.closest("table.datagrid-btable");
tr=tr.parent().children();
var dest=opts.finder.getTr(_a4c,ref,"body",_a53);
if(_a4d.before){
...
var _a58=$.data(_a56,"treegrid");
var opts=_a58.options;
var prow=_9ff(_a56,_a57);
$(_a56).datagrid("deleteRow",_a57);
$.easyui.removeArrayItem(_a58.checkedRows,opts.idField,_a57);
_9e5(_a56);
if(prow){
_a01(_a56,prow[opts.idField]);
}
_a58.total-=1;
$(_a56).datagrid("getPager").pagination("refresh",{total:_a58.total});
...
var _a5b=t.treegrid("getRoots");
if(_a5b.length>1){
_a5c(_a5b[0]).addClass("tree-root-first");
}else{
if(_a5b.length==1){
_a5c(_a5b[0]).addClass("tree-root-one");
}
}
_a5d(_a5b);
_a5e(_a5b);
...
if(_a5f.length){
var cell=_a5c(_a5f[_a5f.length-1]);
...
for(var i=0;i<_a60.length-1;i++){
var node=_a60[i];
var _a61=t.treegrid("getLevel",node[opts.idField]);
var tr=opts.finder.getTr(_a5a,node[opts.idField]);
var cc=tr.next().find("tr.datagrid-row td[field=\""+opts.treeField+"\"] div.datagrid-cell");
cc.find("span:eq("+(_a61-1)+")").addClass("tree-line");
}
};
function _a5c(node){
var tr=opts.finder.getTr(_a5a,node[opts.idField]);
...
$.fn.treegrid=function(_a62,_a63){
if(typeof _a62=="string"){
var _a64=$.fn.treegrid.methods[_a62];
if(_a64){
return _a64(this,_a63);
}else{
return this.datagrid(_a62,_a63);
}
}
_a62=_a62||{};
return this.each(function(){
var _a65=$.data(this,"treegrid");
if(_a65){
$.extend(_a65.options,_a62);
}else{
_a65=$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_a62),data:[],checkedRows:[],tmpIds:[]});
}
_9cc(this);
if(_a65.options.data){
$(this).treegrid("loadData",_a65.options.data);
}
_9dc(this);
});
};
...
},resize:function(jq,_a66){
return jq.each(function(){
$(this).datagrid("resize",_a66);
});
},fixRowHeight:function(jq,_a67){
return jq.each(function(){
_9dd(this,_a67);
});
},loadData:function(jq,data){
return jq.each(function(){
_a0b(this,data.parent,data);
});
},load:function(jq,_a68){
return jq.each(function(){
$(this).treegrid("options").pageNumber=1;
$(this).treegrid("getPager").pagination({pageNumber:1});
$(this).treegrid("reload",_a68);
});
...
_a69=$.extend({},opts.queryParams);
_a69.id=id;
}
if(_a69.id){
var node=$(this).treegrid("find",_a69.id);
if(node.children){
node.children.splice(0,node.children.length);
}
opts.queryParams=_a69;
var tr=opts.finder.getTr(this,_a69.id);
...
},reloadFooter:function(jq,_a6a){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var dc=$.data(this,"datagrid").dc;
if(_a6a){
$.data(this,"treegrid").footer=_a6a;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,dc.footer1,true);
opts.view.renderFooter.call(opts.view,this,dc.footer2,false);
...
},append:function(jq,_a6b){
return jq.each(function(){
_a46(this,_a6b);
});
},insert:function(jq,_a6c){
return jq.each(function(){
_a4b(this,_a6c);
});
...
},update:function(jq,_a6d){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var row=_a6d.row;
opts.view.updateRow.call(opts.view,this,_a6d.id,row);
if(row.checked!=undefined){
row=find(this,_a6d.id);
...
var _a6e=$(this).data("treegrid");
for(var i=0;i<_a6e.tmpIds.length;i++){
_9ee(this,_a6e.tmpIds[i],true,true);
}
_a6e.tmpIds=[];
});
},getCheckedNodes:function(jq,_a6f){
_a6f=_a6f||"checked";
var rows=[];
$.easyui.forEach(jq.data("treegrid").checkedRows,false,function(row){
if(row.checkState==_a6f){
rows.push(row);
}
});
return rows;
...
return jq.each(function(){
var _a70=this;
var opts=$(_a70).treegrid("options");
$(_a70).datagrid("clearChecked");
$.map($(_a70).treegrid("getCheckedNodes"),function(row){
_9ee(_a70,row[opts.idField],false,true);
});
});
}};
$.fn.treegrid.parseOptions=function(_a71){
return $.extend({},$.fn.datagrid.parseOptions(_a71),$.parser.parseOptions(_a71,["treeField",{checkbox:"boolean",cascadeCheck:"boolean",onlyLeafCheck:"boolean"},{animate:"boolean"}]));
};
var _a72=$.extend({},$.fn.datagrid.defaults.view,{render:function(_a73,_a74,_a75){
...
var _a78=_a79.call(this,_a75,this.treeLevel,this.treeNodes);
$(_a74).append(_a78.join(""));
}
function _a79(_a7a,_a7b,_a7c){
var _a7d=$(_a73).treegrid("getParent",_a7c[0][opts.idField]);
var _a7e=(_a7d?_a7d.children.length:$(_a73).treegrid("getRoots").length)-_a7c.length;
var _a7f=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_a7c.length;i++){
var row=_a7c[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var css=opts.rowStyler?opts.rowStyler.call(_a73,row):"";
var cs=this.getStyleValue(css);
var cls="class=\"datagrid-row "+(_a7e++%2&&opts.striped?"datagrid-row-alt ":" ")+cs.c+"\"";
var _a80=cs.s?"style=\""+cs.s+"\"":"";
var _a81=_a77+"-"+(_a7a?1:2)+"-"+row[opts.idField];
_a7f.push("<tr id=\""+_a81+"\" node-id=\""+row[opts.idField]+"\" "+cls+" "+_a80+">");
_a7f=_a7f.concat(view.renderRow.call(view,_a73,_a76,_a7a,_a7b,row));
_a7f.push("</tr>");
if(row.children&&row.children.length){
var tt=_a79.call(this,_a7a,_a7b+1,row.children);
var v=row.state=="closed"?"none":"block";
_a7f.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_a76.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_a7f=_a7f.concat(tt);
_a7f.push("</div></td></tr>");
}
}
...
},renderFooter:function(_a82,_a83,_a84){
var opts=$.data(_a82,"treegrid").options;
var rows=$.data(_a82,"treegrid").footer||[];
var _a85=$(_a82).datagrid("getColumnFields",_a84);
var _a86=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_a86.push("<tr class=\"datagrid-row\" node-id=\""+row[opts.idField]+"\">");
_a86.push(this.renderRow.call(this,_a82,_a85,_a84,0,row));
_a86.push("</tr>");
}
_a86.push("</tbody></table>");
$(_a83).html(_a86.join(""));
},renderRow:function(_a87,_a88,_a89,_a8a,row){
var _a8b=$.data(_a87,"treegrid");
var opts=_a8b.options;
var cc=[];
if(_a89&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_a88.length;i++){
var _a8c=_a88[i];
var col=$(_a87).datagrid("getColumnOption",_a8c);
if(col){
var css=col.styler?(col.styler(row[_a8c],row)||""):"";
var cs=this.getStyleValue(css);
var cls=cs.c?"class=\""+cs.c+"\"":"";
var _a8d=col.hidden?"style=\"display:none;"+cs.s+"\"":(cs.s?"style=\""+cs.s+"\"":"");
cc.push("<td field=\""+_a8c+"\" "+cls+" "+_a8d+">");
var _a8d="";
if(!col.checkbox){
if(col.align){
_a8d+="text-align:"+col.align+";";
}
if(!opts.nowrap){
_a8d+="white-space:normal;height:auto;";
}else{
if(opts.autoRowHeight){
_a8d+="height:auto;";
}
...
cc.push("<div style=\""+_a8d+"\" ");
if(col.checkbox){
cc.push("class=\"datagrid-cell-check ");
}else{
cc.push("class=\"datagrid-cell "+col.cellClass);
}
if(_a8c==opts.treeField){
cc.push(" tree-node");
}
cc.push("\">");
if(col.checkbox){
...
cc.push(" name=\""+_a8c+"\" value=\""+(row[_a8c]!=undefined?row[_a8c]:"")+"\">");
}else{
var val=null;
if(col.formatter){
val=col.formatter(row[_a8c],row);
}else{
val=row[_a8c];
}
if(_a8c==opts.treeField){
for(var j=0;j<_a8a;j++){
cc.push("<span class=\"tree-indent\"></span>");
}
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
...
if(this.hasCheckbox(_a87,row)){
var flag=0;
var crow=$.easyui.getArrayItem(_a8b.checkedRows,opts.idField,row[opts.idField]);
if(crow){
flag=crow.checkState=="checked"?1:2;
row.checkState=crow.checkState;
row.checked=crow.checked;
$.easyui.addArrayItem(_a8b.checkedRows,opts.idField,row);
}else{
var prow=$.easyui.getArrayItem(_a8b.checkedRows,opts.idField,row._parentId);
...
if(row.checked){
$.easyui.addArrayItem(_a8b.tmpIds,row[opts.idField]);
}
}
...
return cc.join("");
},hasCheckbox:function(_a8e,row){
var opts=$.data(_a8e,"treegrid").options;
if(opts.checkbox){
if($.isFunction(opts.checkbox)){
if(opts.checkbox.call(_a8e,row)){
return true;
}else{
return false;
}
...
return false;
},refreshRow:function(_a8f,id){
this.updateRow.call(this,_a8f,id,{});
},updateRow:function(_a90,id,row){
var opts=$.data(_a90,"treegrid").options;
var _a91=$(_a90).treegrid("find",id);
$.extend(_a91,row);
var _a92=$(_a90).treegrid("getLevel",id)-1;
var _a93=opts.rowStyler?opts.rowStyler.call(_a90,_a91):"";
var _a94=$.data(_a90,"datagrid").rowIdPrefix;
var _a95=_a91[opts.idField];
function _a96(_a97){
var _a98=$(_a90).treegrid("getColumnFields",_a97);
var tr=opts.finder.getTr(_a90,id,"body",(_a97?1:2));
var _a99=tr.find("div.datagrid-cell-rownumber").html();
var _a9a=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow(_a90,_a98,_a97,_a92,_a91));
tr.attr("style",_a93||"");
tr.find("div.datagrid-cell-rownumber").html(_a99);
if(_a9a){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
if(_a95!=id){
tr.attr("id",_a94+"-"+(_a97?1:2)+"-"+_a95);
tr.attr("node-id",_a95);
}
};
_a96.call(this,true);
_a96.call(this,false);
$(_a90).treegrid("fixRowHeight",id);
},deleteRow:function(_a9b,id){
var opts=$.data(_a9b,"treegrid").options;
var tr=opts.finder.getTr(_a9b,id);
tr.next("tr.treegrid-tr-tree").remove();
tr.remove();
var _a9c=del(id);
if(_a9c){
if(_a9c.children.length==0){
tr=opts.finder.getTr(_a9b,_a9c[opts.idField]);
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
...
this.setEmptyMsg(_a9b);
function del(id){
var cc;
var _a9d=$(_a9b).treegrid("getParent",id);
if(_a9d){
cc=_a9d.children;
}else{
cc=$(_a9b).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
},onBeforeRender:function(_a9e,_a9f,data){
if($.isArray(_a9f)){
data={total:_a9f.length,rows:_a9f};
_a9f=null;
}
if(!data){
return false;
...
if(data.footer){
_aa0.footer=data.footer;
}
if(data.total){
_aa0.total=data.total;
}
data=this.transfer(_a9e,_a9f,data.rows);
}else{
...
row._parentId=_aa3;
if(row.children&&row.children.length){
_aa1(row.children,row[opts.idField]);
}
}
};
_aa1(data,_a9f);
...
this.sort(_a9e,data);
this.treeNodes=data;
this.treeLevel=$(_a9e).treegrid("getLevel",_a9f);
...
_aa0.data=_aa0.data.concat(data);
}
},sort:function(_aa4,data){
var opts=$.data(_aa4,"treegrid").options;
if(!opts.remoteSort&&opts.sortName){
var _aa5=opts.sortName.split(",");
var _aa6=opts.sortOrder.split(",");
_aa7(data);
}
function _aa7(rows){
...
var sn=_aa5[i];
var so=_aa6[i];
var col=$(_aa4).treegrid("getColumnOption",sn);
var _aa8=col.sorter||function(a,b){
return a==b?0:(a>b?1:-1);
};
r=_aa8(r1[sn],r2[sn])*(so=="asc"?1:-1);
if(r!=0){
return r;
}
}
...
for(var i=0;i<rows.length;i++){
var _aa9=rows[i].children;
if(_aa9&&_aa9.length){
_aa7(_aa9);
}
}
};
},transfer:function(_aaa,_aab,data){
var opts=$.data(_aaa,"treegrid").options;
var rows=$.extend([],data);
var _aac=_aad(_aab,rows);
var toDo=$.extend([],_aac);
while(toDo.length){
var node=toDo.shift();
var _aae=_aad(node[opts.idField],rows);
if(_aae.length){
if(node.children){
node.children=node.children.concat(_aae);
}else{
node.children=_aae;
}
toDo=toDo.concat(_aae);
}
}
return _aac;
function _aad(_aaf,rows){
var rr=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
if(row._parentId==_aaf){
rr.push(row);
rows.splice(i,1);
i--;
}
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,checkbox:false,cascadeCheck:true,onlyLeafCheck:false,lines:false,animate:false,singleSelect:true,view:_a72,rowEvents:$.extend({},$.fn.datagrid.defaults.rowEvents,{mouseover:_9e7(true),mouseout:_9e7(false),click:_9e9}),loader:function(_ab0,_ab1,_ab2){
var opts=$(this).treegrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_ab0,dataType:"json",success:function(data){
_ab1(data);
},error:function(){
_ab2.apply(this,arguments);
}});
},loadFilter:function(data,_ab3){
return data;
},finder:{getTr:function(_ab4,id,type,_ab5){
type=type||"body";
_ab5=_ab5||0;
var dc=$.data(_ab4,"datagrid").dc;
if(_ab5==0){
var opts=$.data(_ab4,"treegrid").options;
var tr1=opts.finder.getTr(_ab4,id,type,1);
var tr2=opts.finder.getTr(_ab4,id,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+$.data(_ab4,"datagrid").rowIdPrefix+"-"+_ab5+"-"+id);
if(!tr.length){
tr=(_ab5==1?dc.body1:dc.body2).find("tr[node-id=\""+id+"\"]");
}
return tr;
}else{
if(type=="footer"){
return (_ab5==1?dc.footer1:dc.footer2).find("tr[node-id=\""+id+"\"]");
}else{
if(type=="selected"){
return (_ab5==1?dc.body1:dc.body2).find("tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_ab5==1?dc.body1:dc.body2).find("tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_ab5==1?dc.body1:dc.body2).find("tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_ab5==1?dc.body1:dc.body2).find("tr:last[node-id]");
}else{
if(type=="allbody"){
return (_ab5==1?dc.body1:dc.body2).find("tr[node-id]");
}else{
if(type=="allfooter"){
return (_ab5==1?dc.footer1:dc.footer2).find("tr[node-id]");
}
}
}
}
...
},getRow:function(_ab6,p){
var id=(typeof p=="object")?p.attr("node-id"):p;
return $(_ab6).treegrid("find",id);
},getRows:function(_ab7){
return $(_ab7).treegrid("getChildren");
}},onBeforeLoad:function(row,_ab8){
...
},onClickCell:function(_ab9,row){
},onDblClickCell:function(_aba,row){
},onContextMenu:function(e,row){
},onBeforeEdit:function(row){
},onAfterEdit:function(row,_abb){
},onCancelEdit:function(row){
},onBeforeCheckNode:function(row,_abc){
},onCheckNode:function(row,_abd){
}});
})(jQuery);
(function($){
function _abe(_abf){
var opts=$.data(_abf,"datalist").options;
$(_abf).datagrid($.extend({},opts,{cls:"datalist"+(opts.lines?" datalist-lines":""),frozenColumns:(opts.frozenColumns&&opts.frozenColumns.length)?opts.frozenColumns:(opts.checkbox?[[{field:"_ck",checkbox:true}]]:undefined),columns:(opts.columns&&opts.columns.length)?opts.columns:[[{field:opts.textField,width:"100%",formatter:function(_ac0,row,_ac1){
return opts.textFormatter?opts.textFormatter(_ac0,row,_ac1):_ac0;
}}]]}));
};
var _ac2=$.extend({},$.fn.datagrid.defaults.view,{render:function(_ac3,_ac4,_ac5){
var _ac6=$.data(_ac3,"datagrid");
var opts=_ac6.options;
if(opts.groupField){
var g=this.groupRows(_ac3,_ac6.data.rows);
this.groups=g.groups;
_ac6.data.rows=g.rows;
var _ac7=[];
for(var i=0;i<g.groups.length;i++){
_ac7.push(this.renderGroup.call(this,_ac3,i,g.groups[i],_ac5));
}
$(_ac4).html(_ac7.join(""));
}else{
$(_ac4).html(this.renderTable(_ac3,0,_ac6.data.rows,_ac5));
}
},renderGroup:function(_ac8,_ac9,_aca,_acb){
var _acc=$.data(_ac8,"datagrid");
var opts=_acc.options;
var _acd=$(_ac8).datagrid("getColumnFields",_acb);
var _ace=[];
_ace.push("<div class=\"datagrid-group\" group-index="+_ac9+">");
if(!_acb){
_ace.push("<span class=\"datagrid-group-title\">");
_ace.push(opts.groupFormatter.call(_ac8,_aca.value,_aca.rows));
_ace.push("</span>");
}
_ace.push("</div>");
_ace.push(this.renderTable(_ac8,_aca.startIndex,_aca.rows,_acb));
return _ace.join("");
},groupRows:function(_acf,rows){
var _ad0=$.data(_acf,"datagrid");
var opts=_ad0.options;
var _ad1=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _ad2=_ad3(row[opts.groupField]);
if(!_ad2){
_ad2={value:row[opts.groupField],rows:[row]};
_ad1.push(_ad2);
}else{
_ad2.rows.push(row);
}
...
var _ad4=0;
var rows=[];
for(var i=0;i<_ad1.length;i++){
var _ad2=_ad1[i];
_ad2.startIndex=_ad4;
_ad4+=_ad2.rows.length;
rows=rows.concat(_ad2.rows);
}
return {groups:_ad1,rows:rows};
function _ad3(_ad5){
for(var i=0;i<_ad1.length;i++){
var _ad6=_ad1[i];
if(_ad6.value==_ad5){
...
$.fn.datalist=function(_ad7,_ad8){
if(typeof _ad7=="string"){
var _ad9=$.fn.datalist.methods[_ad7];
if(_ad9){
return _ad9(this,_ad8);
}else{
return this.datagrid(_ad7,_ad8);
}
}
_ad7=_ad7||{};
return this.each(function(){
var _ada=$.data(this,"datalist");
if(_ada){
$.extend(_ada.options,_ad7);
}else{
var opts=$.extend({},$.fn.datalist.defaults,$.fn.datalist.parseOptions(this),_ad7);
opts.columns=$.extend(true,[],opts.columns);
_ada=$.data(this,"datalist",{options:opts});
}
_abe(this);
if(!_ada.options.data){
...
$.fn.datalist.parseOptions=function(_adb){
return $.extend({},$.fn.datagrid.parseOptions(_adb),$.parser.parseOptions(_adb,["valueField","textField","groupField",{checkbox:"boolean",lines:"boolean"}]));
};
$.fn.datalist.parseData=function(_adc){
var opts=$.data(_adc,"datalist").options;
var data={total:0,rows:[]};
$(_adc).children().each(function(){
var _add=$.parser.parseOptions(this,["value","group"]);
var row={};
var html=$(this).html();
row[opts.valueField]=_add.value!=undefined?_add.value:html;
row[opts.textField]=html;
if(opts.groupField){
row[opts.groupField]=_add.group;
}
data.total++;
data.rows.push(row);
});
...
$.fn.datalist.defaults=$.extend({},$.fn.datagrid.defaults,{fitColumns:true,singleSelect:true,showHeader:false,checkbox:false,lines:false,valueField:"value",textField:"text",groupField:"",view:_ac2,textFormatter:function(_ade,row){
return _ade;
},groupFormatter:function(_adf,rows){
return _adf;
}});
})(jQuery);
(function($){
...
if(!_ae3.panel){
_ae3.panel=$("<div class=\"combo-panel\"></div>").appendTo("body");
_ae3.panel.panel({minWidth:opts.panelMinWidth,maxWidth:opts.panelMaxWidth,minHeight:opts.panelMinHeight,maxHeight:opts.panelMaxHeight,doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
var _ae4=$(this).panel("options").comboTarget;
var _ae5=$.data(_ae4,"combo");
if(_ae5){
_ae5.options.onShowPanel.call(_ae4);
}
},onBeforeClose:function(){
_ae0($(this).parent());
},onClose:function(){
var _ae6=$(this).panel("options").comboTarget;
var _ae7=$(_ae6).data("combo");
if(_ae7){
_ae7.options.onHidePanel.call(_ae6);
}
}});
}
var _ae8=$.extend(true,[],opts.icons);
if(opts.hasDownArrow){
_ae8.push({iconCls:"combo-arrow",handler:function(e){
_aed(e.data.target);
}});
}
$(_ae2).addClass("combo-f").textbox($.extend({},opts,{icons:_ae8,onChange:function(){
}}));
$(_ae2).attr("comboName",$(_ae2).attr("textboxName"));
_ae3.combo=$(_ae2).next();
_ae3.combo.addClass("combo");
_ae3.panel.unbind(".combo");
for(var _ae9 in opts.panelEvents){
_ae3.panel.bind(_ae9+".combo",{target:_ae2},opts.panelEvents[_ae9]);
}
};
function _aea(_aeb){
...
$(_aeb).textbox("destroy");
};
function _aed(_aee){
var _aef=$.data(_aee,"combo").panel;
if(_aef.is(":visible")){
var _af0=_aef.combo("combo");
_af1(_af0);
if(_af0!=_aee){
$(_aee).combo("showPanel");
}
}else{
var p=$(_aee).closest("div.combo-p").children(".combo-panel");
$("div.combo-panel:visible").not(_aef).not(p).panel("close");
$(_aee).combo("showPanel");
}
$(_aee).combo("textbox").focus();
};
function _ae0(_af2){
$(_af2).find(".combo-f").each(function(){
...
function _af7(e){
var _af8=e.data.target;
var t=$(_af8);
var _af9=t.data("combo");
var opts=t.combo("options");
_af9.panel.panel("options").comboTarget=_af8;
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_af8,e);
break;
case 40:
opts.keyHandler.down.call(_af8,e);
break;
case 37:
opts.keyHandler.left.call(_af8,e);
break;
case 39:
opts.keyHandler.right.call(_af8,e);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_af8,e);
return false;
case 9:
case 27:
_af1(_af8);
...
if(opts.editable){
if(_af9.timer){
clearTimeout(_af9.timer);
}
_af9.timer=setTimeout(function(){
var q=t.combo("getText");
if(_af9.previousText!=q){
_af9.previousText=q;
t.combo("showPanel");
opts.keyHandler.query.call(_af8,q,e);
t.combo("validate");
}
},opts.delay);
}
...
var _b00=_aff.combo;
var _b01=_aff.panel;
var opts=$(_afe).combo("options");
var _b02=_b01.panel("options");
_b02.comboTarget=_afe;
if(_b02.closed){
_b01.panel("panel").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:($.fn.window?$.fn.window.defaults.zIndex++:99)),left:-999999});
_b01.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_b00._outerWidth()),height:opts.panelHeight});
_b01.panel("panel").hide();
_b01.panel("open");
}
(function(){
if(_b02.comboTarget==_afe&&_b01.is(":visible")){
_b01.panel("move",{left:_b03(),top:_b04()});
setTimeout(arguments.callee,200);
}
})();
function _b03(){
var left=_b00.offset().left;
if(opts.panelAlign=="right"){
left+=_b00._outerWidth()-_b01._outerWidth();
}
if(left+_b01._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_b01._outerWidth();
}
if(left<0){
left=0;
}
...
var top=_b00.offset().top-_b01._outerHeight();
}else{
if(opts.panelValign=="bottom"){
var top=_b00.offset().top+_b00._outerHeight();
}else{
var top=_b00.offset().top+_b00._outerHeight();
if(top+_b01._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_b00.offset().top-_b01._outerHeight();
}
if(top<$(document).scrollTop()){
top=_b00.offset().top+_b00._outerHeight();
}
}
}
return top;
...
function _af1(_b05){
var _b06=$.data(_b05,"combo").panel;
_b06.panel("close");
};
function _b07(_b08,text){
var _b09=$.data(_b08,"combo");
var _b0a=$(_b08).textbox("getText");
if(_b0a!=text){
$(_b08).textbox("setText",text);
}
_b09.previousText=text;
};
function _b0b(_b0c){
var _b0d=$.data(_b0c,"combo");
var opts=_b0d.options;
var _b0e=$(_b0c).next();
var _b0f=[];
_b0e.find(".textbox-value").each(function(){
_b0f.push($(this).val());
});
if(opts.multivalue){
return _b0f;
}else{
return _b0f.length?_b0f[0].split(opts.separator):_b0f;
}
};
function _b10(_b11,_b12){
var _b13=$.data(_b11,"combo");
var _b14=_b13.combo;
var opts=$(_b11).combo("options");
if(!$.isArray(_b12)){
_b12=_b12.split(opts.separator);
}
var _b15=_b0b(_b11);
_b14.find(".textbox-value").remove();
if(_b12.length){
if(opts.multivalue){
for(var i=0;i<_b12.length;i++){
_b16(_b12[i]);
}
}else{
_b16(_b12.join(opts.separator));
}
}
function _b16(_b17){
var name=$(_b11).attr("textboxName")||"";
var _b18=$("<input type=\"hidden\" class=\"textbox-value\">").appendTo(_b14);
_b18.attr("name",name);
if(opts.disabled){
_b18.attr("disabled","disabled");
}
_b18.val(_b17);
};
var _b19=(function(){
...
if(_b19){
$(_b11).val(_b12.join(opts.separator));
if(opts.multiple){
opts.onChange.call(_b11,_b12,_b15);
}else{
opts.onChange.call(_b11,_b12[0],_b15[0]);
}
$(_b11).closest("form").trigger("_change",[_b11]);
}
};
function _b1a(_b1b){
var _b1c=_b0b(_b1b);
...
function _b20(_b21){
var opts=$.data(_b21,"combo").options;
var _b22=opts.onChange;
opts.onChange=$.parser.emptyFn;
if(opts.multiple){
_b10(_b21,opts.value?opts.value:[]);
}else{
_b1d(_b21,opts.value);
}
opts.onChange=_b22;
};
$.fn.combo=function(_b23,_b24){
if(typeof _b23=="string"){
var _b25=$.fn.combo.methods[_b23];
if(_b25){
return _b25(this,_b24);
}else{
return this.textbox(_b23,_b24);
}
}
_b23=_b23||{};
return this.each(function(){
var _b26=$.data(this,"combo");
if(_b26){
$.extend(_b26.options,_b23);
if(_b23.value!=undefined){
_b26.options.originalValue=_b23.value;
}
}else{
_b26=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_b23),previousText:""});
if(_b26.options.multiple&&_b26.options.value==""){
_b26.options.originalValue=[];
}else{
_b26.options.originalValue=_b26.options.value;
}
}
_ae1(this);
_b20(this);
...
return _b0b(jq[0]);
},setValues:function(jq,_b27){
return jq.each(function(){
_b10(this,_b27);
});
},getValue:function(jq){
return _b1a(jq[0]);
},setValue:function(jq,_b28){
return jq.each(function(){
_b1d(this,_b28);
});
}};
$.fn.combo.parseOptions=function(_b29){
var t=$(_b29);
return $.extend({},$.fn.textbox.parseOptions(_b29),$.parser.parseOptions(_b29,["separator","panelAlign",{panelWidth:"number",hasDownArrow:"boolean",delay:"number",reversed:"boolean",multivalue:"boolean",selectOnNavigation:"boolean"},{panelMinWidth:"number",panelMaxWidth:"number",panelMinHeight:"number",panelMaxHeight:"number"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined)});
};
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_af3,keydown:_af7,paste:_af7,drop:_af7,blur:_afa},panelEvents:{mousedown:function(e){
e.preventDefault();
e.stopPropagation();
...
},onChange:function(_b2a,_b2b){
}});
})(jQuery);
(function($){
function _b2c(_b2d,_b2e){
var _b2f=$.data(_b2d,"combobox");
return $.easyui.indexOfArray(_b2f.data,_b2f.options.valueField,_b2e);
};
function _b30(_b31,_b32){
var opts=$.data(_b31,"combobox").options;
var _b33=$(_b31).combo("panel");
var item=opts.finder.getEl(_b31,_b32);
if(item.length){
if(item.position().top<=0){
var h=_b33.scrollTop()+item.position().top;
_b33.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_b33.height()){
var h=_b33.scrollTop()+item.position().top+item.outerHeight()-_b33.height();
_b33.scrollTop(h);
}
}
}
_b33.triggerHandler("scroll");
};
function nav(_b34,dir){
var opts=$.data(_b34,"combobox").options;
var _b35=$(_b34).combobox("panel");
var item=_b35.children("div.combobox-item-hover");
if(!item.length){
item=_b35.children("div.combobox-item-selected");
}
item.removeClass("combobox-item-hover");
var _b36="div.combobox-item:visible:not(.combobox-item-disabled):first";
var _b37="div.combobox-item:visible:not(.combobox-item-disabled):last";
if(!item.length){
item=_b35.children(dir=="next"?_b36:_b37);
}else{
if(dir=="next"){
item=item.nextAll(_b36);
if(!item.length){
item=_b35.children(_b36);
}
}else{
item=item.prevAll(_b36);
if(!item.length){
item=_b35.children(_b37);
}
}
}
if(item.length){
item.addClass("combobox-item-hover");
var row=opts.finder.getRow(_b34,item);
if(row){
$(_b34).combobox("scrollTo",row[opts.valueField]);
if(opts.selectOnNavigation){
_b38(_b34,row[opts.valueField]);
}
}
}
};
function _b38(_b39,_b3a,_b3b){
var opts=$.data(_b39,"combobox").options;
var _b3c=$(_b39).combo("getValues");
if($.inArray(_b3a+"",_b3c)==-1){
if(opts.multiple){
_b3c.push(_b3a);
}else{
_b3c=[_b3a];
...
var _b41=$(_b3f).combo("getValues");
var _b42=$.inArray(_b40+"",_b41);
if(_b42>=0){
_b41.splice(_b42,1);
_b3d(_b3f,_b41);
}
};
function _b3d(_b43,_b44,_b45){
var opts=$.data(_b43,"combobox").options;
var _b46=$(_b43).combo("panel");
if(!$.isArray(_b44)){
...
var _b47=$(_b43).combo("getValues");
if(_b46.is(":visible")){
_b46.find(".combobox-item-selected").each(function(){
var row=opts.finder.getRow(_b43,$(this));
if(row){
if($.easyui.indexOfArray(_b47,row[opts.valueField])==-1){
...
$.map(_b47,function(v){
if($.easyui.indexOfArray(_b44,v)==-1){
var el=opts.finder.getEl(_b43,v);
if(el.hasClass("combobox-item-selected")){
el.removeClass("combobox-item-selected");
opts.onUnselect.call(_b43,opts.finder.getRow(_b43,v));
}
}
});
var _b48=null;
...
var v=_b44[i];
var s=v;
var row=opts.finder.getRow(_b43,v);
if(row){
...
opts.onSelect.call(_b43,row);
}
}else{
s=_b49(v,opts.mappingRows)||v;
}
vv.push(v);
ss.push(s);
}
if(!_b45){
$(_b43).combo("setText",ss.join(opts.separator));
}
if(opts.showItemIcon){
var tb=$(_b43).combobox("textbox");
tb.removeClass("textbox-bgicon "+opts.textboxIconCls);
if(_b48&&_b48.iconCls){
tb.addClass("textbox-bgicon "+_b48.iconCls);
opts.textboxIconCls=_b48.iconCls;
}
}
$(_b43).combo("setValues",vv);
_b46.triggerHandler("scroll");
function _b49(_b4a,a){
var item=$.easyui.getArrayItem(a,opts.valueField,_b4a);
return item?item[opts.textField]:undefined;
};
};
function _b4b(_b4c,data,_b4d){
var _b4e=$.data(_b4c,"combobox");
var opts=_b4e.options;
_b4e.data=opts.loadFilter.call(_b4c,data);
opts.view.render.call(opts.view,_b4c,$(_b4c).combo("panel"),_b4e.data);
var vv=$(_b4c).combobox("getValues");
$.easyui.forEach(_b4e.data,false,function(row){
if(row["selected"]){
...
_b3d(_b4c,vv.length?[vv[vv.length-1]]:[],_b4d);
}
opts.onLoadSuccess.call(_b4c,data);
};
function _b4f(_b50,url,_b51,_b52){
var opts=$.data(_b50,"combobox").options;
if(url){
opts.url=url;
}
_b51=$.extend({},opts.queryParams,_b51||{});
if(opts.onBeforeLoad.call(_b50,_b51)==false){
return;
}
opts.loader.call(_b50,_b51,function(data){
_b4b(_b50,data,_b52);
},function(){
opts.onLoadError.apply(this,arguments);
});
};
function _b53(_b54,q){
var _b55=$.data(_b54,"combobox");
var opts=_b55.options;
var _b56=$();
var qq=opts.multiple?q.split(opts.separator):[q];
if(opts.mode=="remote"){
_b57(qq);
_b4f(_b54,null,{q:q},true);
}else{
var _b58=$(_b54).combo("panel");
_b58.find(".combobox-item-hover").removeClass("combobox-item-hover");
_b58.find(".combobox-item,.combobox-group").hide();
var data=_b55.data;
var vv=[];
$.map(qq,function(q){
q=$.trim(q);
...
for(var i=0;i<data.length;i++){
var row=data[i];
if(opts.filter.call(_b54,q,row)){
var v=row[opts.valueField];
var s=row[opts.textField];
var g=row[opts.groupField];
var item=opts.finder.getEl(_b54,v).show();
...
if(opts.groupField&&_b5a!=g){
opts.finder.getGroupEl(_b54,g).show();
_b5a=g;
}
}
}
...
function _b57(vv){
if(opts.reversed){
_b56.addClass("combobox-item-hover");
}else{
_b3d(_b54,opts.multiple?(q?vv:[]):vv,true);
}
};
};
function _b5b(_b5c){
...
var _b5d=t.combobox("panel");
var item=_b5d.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_b5c,item);
var _b5e=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
t.combobox("unselect",_b5e);
}else{
t.combobox("select",_b5e);
}
}else{
t.combobox("select",_b5e);
}
...
function _b5f(_b60){
var _b61=$.data(_b60,"combobox");
var opts=_b61.options;
$(_b60).addClass("combobox-f");
$(_b60).combo($.extend({},opts,{onShowPanel:function(){
$(this).combo("panel").find("div.combobox-item:hidden,div.combobox-group:hidden").show();
_b3d(this,$(this).combobox("getValues"),true);
...
function _b64(e){
var _b65=$(this).panel("options").comboTarget;
if(!_b65){
return;
}
var opts=$(_b65).combobox("options");
var item=$(e.target).closest("div.combobox-item");
if(!item.length||item.hasClass("combobox-item-disabled")){
return;
}
var row=opts.finder.getRow(_b65,item);
if(!row){
return;
}
if(opts.blurTimer){
...
opts.onClick.call(_b65,row);
var _b66=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
_b3e(_b65,_b66);
}else{
...
$(_b65).combobox("setValue",_b66).combobox("hidePanel");
}
e.stopPropagation();
};
function _b67(e){
...
var _b69=$(this).children(".combobox-stick");
if(!_b69.length){
_b69=$("<div class=\"combobox-stick\"></div>").appendTo(this);
}
_b69.hide();
var _b6a=$(_b68).data("combobox");
$(this).children(".combobox-group:visible").each(function(){
var g=$(this);
var _b6b=opts.finder.getGroup(_b68,g);
var _b6c=_b6a.data[_b6b.startIndex+_b6b.count-1];
var last=opts.finder.getEl(_b68,_b6c[opts.valueField]);
if(g.position().top<0&&last.position().top>0){
_b69.show().html(g.html());
return false;
}
});
}
};
$.fn.combobox=function(_b6d,_b6e){
if(typeof _b6d=="string"){
var _b6f=$.fn.combobox.methods[_b6d];
if(_b6f){
return _b6f(this,_b6e);
}else{
return this.combo(_b6d,_b6e);
}
}
_b6d=_b6d||{};
return this.each(function(){
var _b70=$.data(this,"combobox");
if(_b70){
$.extend(_b70.options,_b6d);
}else{
_b70=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_b6d),data:[]});
}
_b5f(this);
if(_b70.options.data){
_b4b(this,_b70.options.data);
}else{
...
var _b71=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{width:_b71.width,height:_b71.height,originalValue:_b71.originalValue,disabled:_b71.disabled,readonly:_b71.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},setValues:function(jq,_b72){
return jq.each(function(){
var opts=$(this).combobox("options");
if($.isArray(_b72)){
_b72=$.map(_b72,function(_b73){
if(_b73&&typeof _b73=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.valueField,_b73);
return _b73[opts.valueField];
}else{
return _b73;
}
});
...
},setValue:function(jq,_b74){
return jq.each(function(){
$(this).combobox("setValues",$.isArray(_b74)?_b74:[_b74]);
});
},clear:function(jq){
return jq.each(function(){
_b3d(this,[]);
...
},select:function(jq,_b75){
return jq.each(function(){
_b38(this,_b75);
});
},unselect:function(jq,_b76){
return jq.each(function(){
_b3e(this,_b76);
});
},scrollTo:function(jq,_b77){
return jq.each(function(){
_b30(this,_b77);
});
}};
$.fn.combobox.parseOptions=function(_b78){
var t=$(_b78);
return $.extend({},$.fn.combo.parseOptions(_b78),$.parser.parseOptions(_b78,["valueField","textField","groupField","groupPosition","mode","method","url",{showItemIcon:"boolean",limitToList:"boolean"}]));
};
$.fn.combobox.parseData=function(_b79){
var data=[];
var opts=$(_b79).combobox("options");
$(_b79).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _b7a=$(this).attr("label");
...
row[opts.groupField]=_b7c;
}
data.push(row);
};
};
var _b7d=0;
var _b7e={render:function(_b7f,_b80,data){
var _b81=$.data(_b7f,"combobox");
var opts=_b81.options;
var _b82=$(_b7f).attr("id")||"";
_b7d++;
_b81.itemIdPrefix=_b82+"_easyui_combobox_i"+_b7d;
_b81.groupIdPrefix=_b82+"_easyui_combobox_g"+_b7d;
_b81.groups=[];
var dd=[];
var _b83=undefined;
for(var i=0;i<data.length;i++){
...
if(_b83!=g){
_b83=g;
_b81.groups.push({value:g,startIndex:i,count:1});
dd.push("<div id=\""+(_b81.groupIdPrefix+"_"+(_b81.groups.length-1))+"\" class=\"combobox-group\">");
dd.push(opts.groupFormatter?opts.groupFormatter.call(_b7f,g):g);
dd.push("</div>");
}else{
_b81.groups[_b81.groups.length-1].count++;
}
}else{
_b83=undefined;
}
var cls="combobox-item"+(row.disabled?" combobox-item-disabled":"")+(g?" combobox-gitem":"");
dd.push("<div id=\""+(_b81.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
if(opts.showItemIcon&&row.iconCls){
dd.push("<span class=\"combobox-icon "+row.iconCls+"\"></span>");
}
dd.push(opts.formatter?opts.formatter.call(_b7f,row):s);
dd.push("</div>");
}
$(_b80).html(dd.join(""));
}};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupPosition:"static",groupField:null,groupFormatter:function(_b84){
return _b84;
},mode:"local",method:"post",url:null,data:null,queryParams:{},showItemIcon:false,limitToList:false,unselectedValues:[],mappingRows:[],view:_b7e,keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
...
var _b86=$(_b85).parent().length;
if(_b86){
if(opts.reversed){
$(_b85).combobox("setValues",$(_b85).combobox("getValues"));
}else{
if(opts.limitToList){
var vv=[];
$.map($(_b85).combobox("getValues"),function(v){
var _b87=$.easyui.indexOfArray($(_b85).combobox("getData"),opts.valueField,v);
if(_b87>=0){
vv.push(v);
}
});
$(_b85).combobox("setValues",vv);
}
}
opts.blurTimer=null;
}
...
}}),panelEvents:{mouseover:_b62,mouseout:_b63,mousedown:function(e){
e.preventDefault();
e.stopPropagation();
},click:_b64,scroll:_b67},filter:function(q,row){
var opts=$(this).combobox("options");
return row[opts.textField].toLowerCase().indexOf(q.toLowerCase())>=0;
},formatter:function(row){
var opts=$(this).combobox("options");
return row[opts.textField];
},loader:function(_b88,_b89,_b8a){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_b88,dataType:"json",success:function(data){
_b89(data);
},error:function(){
_b8a.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},finder:{getEl:function(_b8b,_b8c){
var _b8d=_b2c(_b8b,_b8c);
var id=$.data(_b8b,"combobox").itemIdPrefix+"_"+_b8d;
return $("#"+id);
},getGroupEl:function(_b8e,_b8f){
var _b90=$.data(_b8e,"combobox");
var _b91=$.easyui.indexOfArray(_b90.groups,"value",_b8f);
var id=_b90.groupIdPrefix+"_"+_b91;
return $("#"+id);
},getGroup:function(_b92,p){
var _b93=$.data(_b92,"combobox");
var _b94=p.attr("id").substr(_b93.groupIdPrefix.length+1);
return _b93.groups[parseInt(_b94)];
},getRow:function(_b95,p){
var _b96=$.data(_b95,"combobox");
var _b97=(p instanceof $)?p.attr("id").substr(_b96.itemIdPrefix.length+1):_b2c(_b95,p);
return _b96.data[parseInt(_b97)];
}},onBeforeLoad:function(_b98){
},onLoadSuccess:function(data){
},onLoadError:function(){
},onSelect:function(_b99){
},onUnselect:function(_b9a){
},onClick:function(_b9b){
}});
})(jQuery);
(function($){
function _b9c(_b9d){
...
var tree=_b9e.tree;
$(_b9d).addClass("combotree-f");
$(_b9d).combo($.extend({},opts,{onShowPanel:function(){
if(opts.editable){
tree.tree("doFilter","");
}
opts.onShowPanel.call(this);
}}));
var _b9f=$(_b9d).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_b9f);
_b9e.tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _ba0=$(_b9d).combotree("getValues");
if(opts.multiple){
$.map(tree.tree("getChecked"),function(node){
$.easyui.addArrayItem(_ba0,node.id);
});
}
_ba5(_b9d,_ba0,_b9e.remainText);
...
},onCheck:function(node,_ba1){
_b9e.remainText=false;
_ba2(_b9d);
opts.onCheck.call(this,node,_ba1);
}}));
};
function _ba2(_ba3){
...
_ba5(_ba3,vv,_ba4.remainText);
};
function _ba5(_ba6,_ba7,_ba8){
var _ba9=$.data(_ba6,"combotree");
var opts=_ba9.options;
var tree=_ba9.tree;
var _baa=tree.tree("options");
var _bab=_baa.onBeforeCheck;
var _bac=_baa.onCheck;
var _bad=_baa.onBeforeSelect;
var _bae=_baa.onSelect;
_baa.onBeforeCheck=_baa.onCheck=_baa.onBeforeSelect=_baa.onSelect=function(){
};
if(!$.isArray(_ba7)){
_ba7=_ba7.split(opts.separator);
}
if(!opts.multiple){
_ba7=_ba7.length?[_ba7[0]]:[""];
}
var vv=$.map(_ba7,function(_baf){
return String(_baf);
});
...
ss.push(_bb1(v,opts.mappingRows)||v);
...
_baa.onBeforeCheck=_bab;
_baa.onCheck=_bac;
_baa.onBeforeSelect=_bad;
_baa.onSelect=_bae;
if(!_ba8){
var s=ss.join(opts.separator);
if($(_ba6).combo("getText")!=s){
$(_ba6).combo("setText",s);
}
}
$(_ba6).combo("setValues",vv);
function _bb1(_bb2,a){
var item=$.easyui.getArrayItem(a,"id",_bb2);
return item?_bb0(item):undefined;
};
function _bb0(node){
return node[opts.textField||""]||node.text;
};
};
function _bb3(_bb4,q){
var _bb5=$.data(_bb4,"combotree");
var opts=_bb5.options;
var tree=_bb5.tree;
_bb5.remainText=true;
tree.tree("doFilter",opts.multiple?q.split(opts.separator):q);
};
function _bb6(_bb7){
var _bb8=$.data(_bb7,"combotree");
_bb8.remainText=false;
$(_bb7).combotree("setValues",$(_bb7).combotree("getValues"));
$(_bb7).combotree("hidePanel");
};
$.fn.combotree=function(_bb9,_bba){
if(typeof _bb9=="string"){
var _bbb=$.fn.combotree.methods[_bb9];
if(_bbb){
return _bbb(this,_bba);
}else{
return this.combo(_bb9,_bba);
}
}
_bb9=_bb9||{};
return this.each(function(){
var _bbc=$.data(this,"combotree");
if(_bbc){
$.extend(_bbc.options,_bb9);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_bb9)});
}
_b9c(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _bbd=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{width:_bbd.width,height:_bbd.height,originalValue:_bbd.originalValue,disabled:_bbd.disabled,readonly:_bbd.readonly});
},clone:function(jq,_bbe){
var t=jq.combo("clone",_bbe);
...
},setValues:function(jq,_bbf){
return jq.each(function(){
var opts=$(this).combotree("options");
if($.isArray(_bbf)){
_bbf=$.map(_bbf,function(_bc0){
if(_bc0&&typeof _bc0=="object"){
$.easyui.addArrayItem(opts.mappingRows,"id",_bc0);
return _bc0.id;
}else{
return _bc0;
}
...
},setValue:function(jq,_bc1){
return jq.each(function(){
$(this).combotree("setValues",$.isArray(_bc1)?_bc1:[_bc1]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotree.parseOptions=function(_bc2){
return $.extend({},$.fn.combo.parseOptions(_bc2),$.fn.tree.parseOptions(_bc2));
};
...
(function($){
function _bc3(_bc4){
var _bc5=$.data(_bc4,"combogrid");
var opts=_bc5.options;
var grid=_bc5.grid;
$(_bc4).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
_bdc(this,$(this).combogrid("getValues"),true);
var p=$(this).combogrid("panel");
var _bc6=p.outerHeight()-p.height();
var _bc7=p._size("minHeight");
var _bc8=p._size("maxHeight");
var dg=$(this).combogrid("grid");
dg.datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_bc7?_bc7-_bc6:""),maxHeight:(_bc8?_bc8-_bc6:"")});
...
var _bc9=$(_bc4).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_bc9);
_bc5.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:_bca,onClickRow:_bcb,onSelect:_bcc("onSelect"),onUnselect:_bcc("onUnselect"),onSelectAll:_bcc("onSelectAll"),onUnselectAll:_bcc("onUnselectAll")}));
function _bcd(dg){
return $(dg).closest(".combo-panel").panel("options").comboTarget||_bc4;
};
function _bca(data){
var _bce=_bcd(this);
var _bcf=$(_bce).data("combogrid");
var opts=_bcf.options;
var _bd0=$(_bce).combo("getValues");
_bdc(_bce,_bd0,_bcf.remainText);
opts.onLoadSuccess.call(this,data);
};
function _bcb(_bd1,row){
var _bd2=_bcd(this);
var _bd3=$(_bd2).data("combogrid");
var opts=_bd3.options;
_bd3.remainText=false;
_bd4.call(this);
if(!opts.multiple){
$(_bd2).combo("hidePanel");
}
opts.onClickRow.call(this,_bd1,row);
};
function _bcc(_bd5){
return function(_bd6,row){
var _bd7=_bcd(this);
var opts=$(_bd7).combogrid("options");
if(_bd5=="onUnselectAll"){
if(opts.multiple){
_bd4.call(this);
}
}else{
...
vv=vv.concat(opts.unselectedValues);
var _bda=dg.data("datagrid").dc.body2;
var _bdb=_bda.scrollTop();
_bdc(_bd8,vv,_bd9.remainText);
_bda.scrollTop(_bdb);
};
};
function nav(_bdd,dir){
var _bde=$.data(_bdd,"combogrid");
var opts=_bde.options;
var grid=_bde.grid;
var _bdf=grid.datagrid("getRows").length;
if(!_bdf){
return;
}
...
grid.datagrid("highlightRow",_be0);
if(opts.selectOnNavigation){
_bde.remainText=false;
grid.datagrid("selectRow",_be0);
}
};
function _bdc(_be1,_be2,_be3){
var _be4=$.data(_be1,"combogrid");
var opts=_be4.options;
var grid=_be4.grid;
var _be5=$(_be1).combo("getValues");
var _be6=$(_be1).combo("options");
var _be7=_be6.onChange;
_be6.onChange=function(){
};
var _be8=grid.datagrid("options");
var _be9=_be8.onSelect;
var _bea=_be8.onUnselectAll;
_be8.onSelect=_be8.onUnselectAll=function(){
};
if(!$.isArray(_be2)){
_be2=_be2.split(opts.separator);
}
if(!opts.multiple){
_be2=_be2.length?[_be2[0]]:[""];
}
var vv=$.map(_be2,function(_beb){
return String(_beb);
});
vv=$.grep(vv,function(v,_bec){
return _bec===$.inArray(v,vv);
});
var _bed=$.grep(grid.datagrid("getSelections"),function(row,_bee){
return $.inArray(String(row[opts.idField]),vv)>=0;
});
grid.datagrid("clearSelections");
grid.data("datagrid").selectedRows=_bed;
var ss=[];
opts.unselectedValues=[];
$.map(vv,function(v){
var _bef=grid.datagrid("getRowIndex",v);
if(_bef>=0){
grid.datagrid("selectRow",_bef);
}else{
opts.unselectedValues.push(v);
}
ss.push(_bf0(v,grid.datagrid("getRows"))||_bf0(v,_bed)||_bf0(v,opts.mappingRows)||v);
});
$(_be1).combo("setValues",_be5);
_be6.onChange=_be7;
_be8.onSelect=_be9;
_be8.onUnselectAll=_bea;
if(!_be3){
var s=ss.join(opts.separator);
if($(_be1).combo("getText")!=s){
$(_be1).combo("setText",s);
}
}
$(_be1).combo("setValues",_be2);
function _bf0(_bf1,a){
var item=$.easyui.getArrayItem(a,opts.idField,_bf1);
return item?item[opts.textField]:undefined;
};
};
function _bf2(_bf3,q){
var _bf4=$.data(_bf3,"combogrid");
var opts=_bf4.options;
var grid=_bf4.grid;
_bf4.remainText=true;
var qq=opts.multiple?q.split(opts.separator):[q];
...
q=$.trim(q);
var _bf6=q;
_bf7(opts.mappingRows,q);
_bf7(grid.datagrid("getSelections"),q);
var _bf8=_bf7(rows,q);
if(_bf8>=0){
if(opts.reversed){
grid.datagrid("highlightRow",_bf8);
}
}else{
$.map(rows,function(row,i){
if(opts.filter.call(_bf3,q,row)){
...
var grid=_bfb.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_bfb.remainText=false;
if(tr.length){
var _bfc=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_bfc);
}else{
grid.datagrid("selectRow",_bfc);
}
}else{
grid.datagrid("selectRow",_bfc);
}
...
$(_bfa).combogrid("setValues",vv);
if(!opts.multiple){
$(_bfa).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_bfd,_bfe){
if(typeof _bfd=="string"){
var _bff=$.fn.combogrid.methods[_bfd];
if(_bff){
...
_bfd=_bfd||{};
return this.each(function(){
var _c00=$.data(this,"combogrid");
if(_c00){
$.extend(_c00.options,_bfd);
}else{
_c00=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_bfd)});
}
_bc3(this);
});
};
...
return $.extend($.data(jq[0],"combogrid").options,{width:_c01.width,height:_c01.height,originalValue:_c01.originalValue,disabled:_c01.disabled,readonly:_c01.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},setValues:function(jq,_c02){
return jq.each(function(){
var opts=$(this).combogrid("options");
if($.isArray(_c02)){
_c02=$.map(_c02,function(_c03){
if(_c03&&typeof _c03=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_c03);
return _c03[opts.idField];
}else{
return _c03;
}
});
...
},setValue:function(jq,_c04){
return jq.each(function(){
$(this).combogrid("setValues",$.isArray(_c04)?_c04:[_c04]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combogrid.parseOptions=function(_c05){
var t=$(_c05);
return $.extend({},$.fn.combo.parseOptions(_c05),$.fn.datagrid.parseOptions(_c05),$.parser.parseOptions(_c05,["idField","textField","mode"]));
};
...
$.fn.combo.defaults.inputEvents.blur(e);
var _c06=e.data.target;
var opts=$(_c06).combogrid("options");
if(opts.reversed){
$(_c06).combogrid("setValues",$(_c06).combogrid("getValues"));
}
...
$(_c08).addClass("combotreegrid-f").combo($.extend({},opts,{onShowPanel:function(){
var p=$(this).combotreegrid("panel");
var _c0a=p.outerHeight()-p.height();
var _c0b=p._size("minHeight");
var _c0c=p._size("maxHeight");
var dg=$(this).combotreegrid("grid");
dg.treegrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_c0b?_c0b-_c0a:""),maxHeight:(_c0c?_c0c-_c0a:"")});
...
_c09.grid=$("<table></table>").appendTo(_c0d);
}
_c09.grid.treegrid($.extend({},opts,{border:false,checkbox:opts.multiple,onLoadSuccess:function(row,data){
var _c0e=$(_c08).combotreegrid("getValues");
if(opts.multiple){
$.map($(this).treegrid("getCheckedNodes"),function(row){
$.easyui.addArrayItem(_c0e,row[opts.idField]);
});
}
_c13(_c08,_c0e);
...
$(_c08).combo("hidePanel");
}
_c10(_c08);
opts.onClickRow.call(this,row);
},onCheckNode:function(row,_c0f){
_c10(_c08);
opts.onCheckNode.call(this,row,_c0f);
}}));
};
function _c10(_c11){
var _c12=$.data(_c11,"combotreegrid");
...
function _c13(_c14,_c15){
var _c16=$.data(_c14,"combotreegrid");
var opts=_c16.options;
var grid=_c16.grid;
var _c17=grid.datagrid("options");
var _c18=_c17.onBeforeCheck;
var _c19=_c17.onCheck;
var _c1a=_c17.onBeforeSelect;
var _c1b=_c17.onSelect;
_c17.onBeforeCheck=_c17.onCheck=_c17.onBeforeSelect=_c17.onSelect=function(){
};
if(!$.isArray(_c15)){
_c15=_c15.split(opts.separator);
}
if(!opts.multiple){
_c15=_c15.length?[_c15[0]]:[""];
}
var vv=$.map(_c15,function(_c1c){
return String(_c1c);
});
vv=$.grep(vv,function(v,_c1d){
return _c1d===$.inArray(v,vv);
});
var _c1e=grid.treegrid("getSelected");
if(_c1e){
grid.treegrid("unselect",_c1e[opts.idField]);
}
...
ss.push(_c20(v,opts.mappingRows)||v);
opts.unselectedValues.push(v);
}
});
if(opts.multiple){
...
_c17.onBeforeCheck=_c18;
_c17.onCheck=_c19;
_c17.onBeforeSelect=_c1a;
_c17.onSelect=_c1b;
if(!_c16.remainText){
var s=ss.join(opts.separator);
if($(_c14).combo("getText")!=s){
$(_c14).combo("setText",s);
}
}
$(_c14).combo("setValues",vv);
function _c20(_c21,a){
var item=$.easyui.getArrayItem(a,opts.idField,_c21);
return item?_c1f(item):undefined;
};
function _c1f(row){
return row[opts.textField||""]||row[opts.treeField];
};
};
function _c22(_c23,q){
var _c24=$.data(_c23,"combotreegrid");
var opts=_c24.options;
var grid=_c24.grid;
_c24.remainText=true;
var qq=opts.multiple?q.split(opts.separator):[q];
qq=$.grep(qq,function(q){
return $.trim(q)!="";
});
...
if(opts.filter.call(_c23,q,row)){
...
_c25(vv);
_c24.remainText=false;
}
}
function _c25(vv){
if(!opts.reversed){
$(_c23).combotreegrid("setValues",vv);
}
};
};
function _c26(_c27){
var _c28=$.data(_c27,"combotreegrid");
var opts=_c28.options;
var grid=_c28.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_c28.remainText=false;
if(tr.length){
...
$(_c27).combotreegrid("setValues",vv);
if(!opts.multiple){
$(_c27).combotreegrid("hidePanel");
}
};
$.fn.combotreegrid=function(_c29,_c2a){
if(typeof _c29=="string"){
var _c2b=$.fn.combotreegrid.methods[_c29];
if(_c2b){
...
_c29=_c29||{};
return this.each(function(){
var _c2c=$.data(this,"combotreegrid");
if(_c2c){
$.extend(_c2c.options,_c29);
}else{
_c2c=$.data(this,"combotreegrid",{options:$.extend({},$.fn.combotreegrid.defaults,$.fn.combotreegrid.parseOptions(this),_c29)});
}
_c07(this);
});
};
...
return $.extend($.data(jq[0],"combotreegrid").options,{width:_c2d.width,height:_c2d.height,originalValue:_c2d.originalValue,disabled:_c2d.disabled,readonly:_c2d.readonly});
},grid:function(jq){
...
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_c2f);
return _c2f[opts.idField];
}else{
return _c2f;
}
});
...
return jq.each(function(){
$(this).combotreegrid("setValues",$.isArray(_c30)?_c30:[_c30]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotreegrid.parseOptions=function(_c31){
var t=$(_c31);
return $.extend({},$.fn.combo.parseOptions(_c31),$.fn.treegrid.parseOptions(_c31),$.parser.parseOptions(_c31,["mode",{limitToGrid:"boolean"}]));
};
...
$.fn.combo.defaults.inputEvents.blur(e);
var _c32=e.data.target;
var opts=$(_c32).combotreegrid("options");
if(opts.limitToGrid){
_c26(_c32);
}
}}),filter:function(q,row){
...
(function($){
function _c33(_c34){
var _c35=$.data(_c34,"tagbox");
var opts=_c35.options;
$(_c34).addClass("tagbox-f").combobox($.extend({},opts,{cls:"tagbox",reversed:true,onChange:function(_c36,_c37){
_c38();
$(this).combobox("hidePanel");
opts.onChange.call(_c34,_c36,_c37);
},onResizing:function(_c39,_c3a){
var _c3b=$(this).combobox("textbox");
var tb=$(this).data("textbox").textbox;
var _c3c=tb.outerWidth();
tb.css({height:"",paddingLeft:_c3b.css("marginLeft"),paddingRight:_c3b.css("marginRight")});
_c3b.css("margin",0);
tb._outerWidth(_c3c);
_c4f(_c34);
_c41(this);
opts.onResizing.call(_c34,_c39,_c3a);
},onLoadSuccess:function(data){
_c38();
opts.onLoadSuccess.call(_c34,data);
}}));
_c38();
_c4f(_c34);
function _c38(){
$(_c34).next().find(".tagbox-label").remove();
var _c3d=$(_c34).tagbox("textbox");
var ss=[];
$.map($(_c34).tagbox("getValues"),function(_c3e,_c3f){
var row=opts.finder.getRow(_c34,_c3e);
var text=opts.tagFormatter.call(_c34,_c3e,row);
var cs={};
var css=opts.tagStyler.call(_c34,_c3e,row)||"";
if(typeof css=="string"){
cs={s:css};
}else{
cs={c:css["class"]||"",s:css["style"]||""};
}
var _c40=$("<span class=\"tagbox-label\"></span>").insertBefore(_c3d).html(text);
_c40.attr("tagbox-index",_c3f);
_c40.attr("style",cs.s).addClass(cs.c);
$("<a href=\"javascript:;\" class=\"tagbox-remove\"></a>").appendTo(_c40);
});
_c41(_c34);
$(_c34).combobox("setText","");
};
};
function _c41(_c42,_c43){
var span=$(_c42).next();
var _c44=_c43?$(_c43):span.find(".tagbox-label");
if(_c44.length){
var _c45=$(_c42).tagbox("textbox");
var _c46=$(_c44[0]);
var _c47=_c46.outerHeight(true)-_c46.outerHeight();
var _c48=_c45.outerHeight()-_c47*2;
_c44.css({height:_c48+"px",lineHeight:_c48+"px"});
var _c49=span.find(".textbox-addon").css("height","100%");
_c49.find(".textbox-icon").css("height","100%");
...
var _c4c=parseInt($(e.target).parent().attr("tagbox-index"));
var _c4d=$(_c4b).tagbox("getValues");
if(opts.onBeforeRemoveTag.call(_c4b,_c4d[_c4c])==false){
return;
}
opts.onRemoveTag.call(_c4b,_c4d[_c4c]);
_c4d.splice(_c4c,1);
$(_c4b).tagbox("setValues",_c4d);
}else{
var _c4e=$(e.target).closest(".tagbox-label");
if(_c4e.length){
var _c4c=parseInt(_c4e.attr("tagbox-index"));
var _c4d=$(_c4b).tagbox("getValues");
opts.onClickTag.call(_c4b,_c4d[_c4c]);
}
}
...
function _c4f(_c50){
var opts=$(_c50).tagbox("options");
var _c51=$(_c50).tagbox("textbox");
var span=$(_c50).next();
var tmp=$("<span></span>").appendTo("body");
tmp.attr("style",_c51.attr("style"));
tmp.css({position:"absolute",top:-9999,left:-9999,width:"auto",fontFamily:_c51.css("fontFamily"),fontSize:_c51.css("fontSize"),fontWeight:_c51.css("fontWeight"),whiteSpace:"nowrap"});
var _c52=_c53(_c51.val());
var _c54=_c53(opts.prompt||"");
tmp.remove();
var _c55=Math.min(Math.max(_c52,_c54)+20,span.width());
_c51._outerWidth(_c55);
span.find(".textbox-button").linkbutton("resize",{height:"100%"});
function _c53(val){
...
if(opts.limitToList){
var _c58=t.tagbox("panel");
var item=_c58.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_c57,item);
var _c59=row[opts.valueField];
$(_c57).tagbox(item.hasClass("combobox-item-selected")?"unselect":"select",_c59);
}
$(_c57).tagbox("hidePanel");
}else{
var v=$.trim($(_c57).tagbox("getText"));
if(v!==""){
var _c5a=$(_c57).tagbox("getValues");
_c5a.push(v);
$(_c57).tagbox("setValues",_c5a);
}
}
};
function _c5b(_c5c,_c5d){
$(_c5c).combobox("setText","");
_c4f(_c5c);
$(_c5c).combobox("setValues",_c5d);
$(_c5c).combobox("setText","");
$(_c5c).tagbox("validate");
};
$.fn.tagbox=function(_c5e,_c5f){
if(typeof _c5e=="string"){
var _c60=$.fn.tagbox.methods[_c5e];
if(_c60){
return _c60(this,_c5f);
}else{
return this.combobox(_c5e,_c5f);
}
}
_c5e=_c5e||{};
return this.each(function(){
var _c61=$.data(this,"tagbox");
if(_c61){
$.extend(_c61.options,_c5e);
}else{
$.data(this,"tagbox",{options:$.extend({},$.fn.tagbox.defaults,$.fn.tagbox.parseOptions(this),_c5e)});
}
_c33(this);
_c4a(this);
});
...
var _c62=jq.combobox("options");
return $.extend($.data(jq[0],"tagbox").options,{width:_c62.width,height:_c62.height,originalValue:_c62.originalValue,disabled:_c62.disabled,readonly:_c62.readonly});
...
$.fn.tagbox.parseOptions=function(_c64){
return $.extend({},$.fn.combobox.parseOptions(_c64),$.parser.parseOptions(_c64,[]));
};
$.fn.tagbox.defaults=$.extend({},$.fn.combobox.defaults,{hasDownArrow:false,multiple:true,reversed:true,selectOnNavigation:false,tipOptions:$.extend({},$.fn.textbox.defaults.tipOptions,{showDelay:200}),val:function(_c65){
var vv=$(_c65).parent().prev().tagbox("getValues");
if($(_c65).is(":focus")){
vv.push($(_c65).val());
}
return vv.join(",");
},inputEvents:$.extend({},$.fn.combo.defaults.inputEvents,{blur:function(e){
var _c66=e.data.target;
var opts=$(_c66).tagbox("options");
if(opts.limitToList){
_c56(_c66);
}
...
}}),tagFormatter:function(_c67,row){
var opts=$(this).tagbox("options");
return row?row[opts.textField]:_c67;
},tagStyler:function(_c68,row){
return "";
},onClickTag:function(_c69){
},onBeforeRemoveTag:function(_c6a){
},onRemoveTag:function(_c6b){
}});
})(jQuery);
(function($){
function _c6c(_c6d){
var _c6e=$.data(_c6d,"datebox");
var opts=_c6e.options;
$(_c6d).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_c6f(this);
_c70(this);
_c71(this);
_c7f(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_c6e.calendar){
var _c72=$(_c6d).combo("panel").css("overflow","hidden");
_c72.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_c72);
...
_c6e.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_c6e.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _c73=this.target;
var opts=$(_c73).datebox("options");
opts.onSelect.call(_c73,date);
_c7f(_c73,opts.formatter.call(_c73,date));
$(_c73).combo("hidePanel");
}});
}
$(_c6d).combo("textbox").parent().addClass("datebox");
$(_c6d).datebox("initValue",opts.value);
function _c6f(_c74){
var opts=$(_c74).datebox("options");
var _c75=$(_c74).combo("panel");
_c75.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _c76=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_c76].handler.call(e.target,_c74);
}
});
};
function _c70(_c77){
var _c78=$(_c77).combo("panel");
if(_c78.children("div.datebox-button").length){
return;
}
var _c79=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_c78);
var tr=_c79.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:;\"></a>").html($.isFunction(btn.text)?btn.text(_c77):btn.text).appendTo(td);
...
var cc=_c7b.children("div.datebox-calendar-inner");
_c7b.children()._outerWidth(_c7b.width());
_c6e.calendar.appendTo(cc);
_c6e.calendar[0].target=_c7a;
if(opts.panelHeight!="auto"){
var _c7c=_c7b.height();
_c7b.children().not(cc).each(function(){
_c7c-=$(this).outerHeight();
});
cc._outerHeight(_c7c);
}
_c6e.calendar.calendar("resize");
};
};
...
function _c80(_c81){
var _c82=$.data(_c81,"datebox");
var opts=_c82.options;
var _c83=_c82.calendar.calendar("options").current;
if(_c83){
_c7f(_c81,opts.formatter.call(_c81,_c83));
$(_c81).combo("hidePanel");
}
};
function _c7f(_c84,_c85,_c86){
var _c87=$.data(_c84,"datebox");
var opts=_c87.options;
var _c88=_c87.calendar;
_c88.calendar("moveTo",opts.parser.call(_c84,_c85));
if(_c86){
$(_c84).combo("setValue",_c85);
}else{
if(_c85){
_c85=opts.formatter.call(_c84,_c88.calendar("options").current);
}
$(_c84).combo("setText",_c85).combo("setValue",_c85);
}
};
$.fn.datebox=function(_c89,_c8a){
if(typeof _c89=="string"){
var _c8b=$.fn.datebox.methods[_c89];
if(_c8b){
return _c8b(this,_c8a);
}else{
return this.combo(_c89,_c8a);
}
}
_c89=_c89||{};
return this.each(function(){
var _c8c=$.data(this,"datebox");
if(_c8c){
$.extend(_c8c.options,_c89);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_c89)});
}
_c6c(this);
});
};
$.fn.datebox.methods={options:function(jq){
var _c8d=jq.combo("options");
return $.extend($.data(jq[0],"datebox").options,{width:_c8d.width,height:_c8d.height,originalValue:_c8d.originalValue,disabled:_c8d.disabled,readonly:_c8d.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},initValue:function(jq,_c8e){
return jq.each(function(){
var opts=$(this).datebox("options");
var _c8f=opts.value;
if(_c8f){
_c8f=opts.formatter.call(this,opts.parser.call(this,_c8f));
}
$(this).combo("initValue",_c8f).combo("setText",_c8f);
});
},setValue:function(jq,_c90){
return jq.each(function(){
_c7f(this,_c90);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_c91){
return $.extend({},$.fn.combo.parseOptions(_c91),$.parser.parseOptions(_c91,["sharedCalendar"]));
};
...
_c7d(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_c92){
return $(_c92).datebox("options").currentText;
},handler:function(_c93){
var opts=$(_c93).datebox("options");
var now=new Date();
var _c94=new Date(now.getFullYear(),now.getMonth(),now.getDate());
$(_c93).datebox("calendar").calendar({year:_c94.getFullYear(),month:_c94.getMonth()+1,current:_c94});
opts.onSelect.call(_c93,_c94);
_c80(_c93);
}},{text:function(_c95){
return $(_c95).datebox("options").closeText;
...
var _c97=$(this).datebox("calendar").calendar("options");
if(!s){
return new _c97.Date();
}
var ss=s.split("/");
...
(function($){
function _c98(_c99){
var _c9a=$.data(_c99,"datetimebox");
var opts=_c9a.options;
$(_c99).datebox($.extend({},opts,{onShowPanel:function(){
var _c9b=$(this).datetimebox("getValue");
_ca1(this,_c9b,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_c99).removeClass("datebox-f").addClass("datetimebox-f");
$(_c99).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_c9a.spinner){
var _c9c=$(_c99).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_c9c.children("div.datebox-calendar-inner"));
_c9a.spinner=p.children("input");
}
_c9a.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator,hour12:opts.hour12});
$(_c99).datetimebox("initValue",opts.value);
};
function _c9d(_c9e){
var c=$(_c9e).datetimebox("calendar");
var t=$(_c9e).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _c9f(_ca0,q){
_ca1(_ca0,q,true);
};
function _ca2(_ca3){
var opts=$.data(_ca3,"datetimebox").options;
var date=_c9d(_ca3);
_ca1(_ca3,opts.formatter.call(_ca3,date));
$(_ca3).combo("hidePanel");
};
function _ca1(_ca4,_ca5,_ca6){
var opts=$.data(_ca4,"datetimebox").options;
$(_ca4).combo("setValue",_ca5);
if(!_ca6){
if(_ca5){
var date=opts.parser.call(_ca4,_ca5);
$(_ca4).combo("setText",opts.formatter.call(_ca4,date));
$(_ca4).combo("setValue",opts.formatter.call(_ca4,date));
}else{
$(_ca4).combo("setText",_ca5);
}
}
var date=opts.parser.call(_ca4,_ca5);
$(_ca4).datetimebox("calendar").calendar("moveTo",date);
$(_ca4).datetimebox("spinner").timespinner("setValue",_ca7(date));
function _ca7(date){
function _ca8(_ca9){
return (_ca9<10?"0":"")+_ca9;
};
var tt=[_ca8(date.getHours()),_ca8(date.getMinutes())];
if(opts.showSeconds){
tt.push(_ca8(date.getSeconds()));
}
return tt.join($(_ca4).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_caa,_cab){
if(typeof _caa=="string"){
var _cac=$.fn.datetimebox.methods[_caa];
if(_cac){
return _cac(this,_cab);
}else{
return this.datebox(_caa,_cab);
}
}
_caa=_caa||{};
return this.each(function(){
var _cad=$.data(this,"datetimebox");
if(_cad){
$.extend(_cad.options,_caa);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_caa)});
}
_c98(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _cae=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_cae.originalValue,disabled:_cae.disabled,readonly:_cae.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_caf){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _cb0=opts.value;
if(_cb0){
_cb0=opts.formatter.call(this,opts.parser.call(this,_cb0));
}
$(this).combo("initValue",_cb0).combo("setText",_cb0);
});
},setValue:function(jq,_cb1){
return jq.each(function(){
_ca1(this,_cb1);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_cb2){
var t=$(_cb2);
return $.extend({},$.fn.datebox.parseOptions(_cb2),$.parser.parseOptions(_cb2,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_c9f(this,q);
}},buttons:[{text:function(_cb3){
return $(_cb3).datetimebox("options").currentText;
},handler:function(_cb4){
var opts=$(_cb4).datetimebox("options");
_ca1(_cb4,opts.formatter.call(_cb4,new Date()));
$(_cb4).datetimebox("hidePanel");
}},{text:function(_cb5){
return $(_cb5).datetimebox("options").okText;
},handler:function(_cb6){
_ca2(_cb6);
}},{text:function(_cb7){
return $(_cb7).datetimebox("options").closeText;
},handler:function(_cb8){
$(_cb8).datetimebox("hidePanel");
}}],formatter:function(date){
if(!date){
return "";
}
...
var dt=s.split(" ");
var _cb9=$.fn.datebox.defaults.parser.call(this,dt[0]);
if(dt.length<2){
return _cb9;
}
var _cba=$.fn.timespinner.defaults.parser.call($(this).datetimebox("spinner")[0],dt[1]+(dt[2]?" "+dt[2]:""));
return new Date(_cb9.getFullYear(),_cb9.getMonth(),_cb9.getDate(),_cba.getHours(),_cba.getMinutes(),_cba.getSeconds());
}});
})(jQuery);
(function($){
function init(_cbb){
var _cbc=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_cbb);
var t=$(_cbb);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_cbc.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_cbc.bind("_resize",function(e,_cbd){
if($(this).hasClass("easyui-fluid")||_cbd){
_cbe(_cbb);
}
return false;
});
...
function _cbe(_cbf,_cc0){
var _cc1=$.data(_cbf,"slider");
var opts=_cc1.options;
var _cc2=_cc1.slider;
if(_cc0){
if(_cc0.width){
opts.width=_cc0.width;
}
if(_cc0.height){
opts.height=_cc0.height;
}
}
_cc2._size(opts);
if(opts.mode=="h"){
_cc2.css("height","");
_cc2.children("div").css("height","");
}else{
_cc2.css("width","");
_cc2.children("div").css("width","");
_cc2.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_cc2._outerHeight());
}
_cc3(_cbf);
};
function _cc4(_cc5){
...
_cc8(aa);
function _cc8(aa){
var rule=_cc7.find("div.slider-rule");
var _cc9=_cc7.find("div.slider-rulelabel");
rule.empty();
_cc9.empty();
for(var i=0;i<aa.length;i++){
var _cca=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_cca);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_cc9);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_cca,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_cca,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _ccb(_ccc){
var _ccd=$.data(_ccc,"slider");
var opts=_ccd.options;
var _cce=_ccd.slider;
_cce.removeClass("slider-h slider-v slider-disabled");
_cce.addClass(opts.mode=="h"?"slider-h":"slider-v");
_cce.addClass(opts.disabled?"slider-disabled":"");
var _ccf=_cce.find(".slider-inner");
_ccf.html("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_ccf.append("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_cce.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_ccd.isDragging=true;
opts.onSlideStart.call(_ccc,opts.value);
},onStopDrag:function(e){
_cd1(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_ccc,opts.value);
opts.onComplete.call(_ccc,opts.value);
_ccd.isDragging=false;
}});
_cce.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_ccd.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_cd1(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_ccc,opts.value);
});
function _cd2(_cd3){
var dd=String(opts.step).split(".");
var dlen=dd.length>1?dd[1].length:0;
return parseFloat(_cd3.toFixed(dlen));
};
function _cd1(pos,_cd4){
var _cd5=_cd6(_ccc,pos);
var s=Math.abs(_cd5%opts.step);
if(s<opts.step/2){
_cd5-=s;
}else{
_cd5=_cd5-s+opts.step;
}
_cd5=_cd2(_cd5);
if(opts.range){
var v1=opts.value[0];
...
if(_cd4){
var _cd7=$(_cd4).nextAll(".slider-handle").length>0;
if(_cd5<=v2&&_cd7){
v1=_cd5;
}else{
if(_cd5>=v1&&(!_cd7)){
...
_cd5<m?v1=_cd5:v2=_cd5;
}
}
}
$(_ccc).slider("setValues",[v1,v2]);
}else{
$(_ccc).slider("setValue",_cd5);
}
};
};
function _cd8(_cd9,_cda){
var _cdb=$.data(_cd9,"slider");
var opts=_cdb.options;
var _cdc=_cdb.slider;
var _cdd=$.isArray(opts.value)?opts.value:[opts.value];
var _cde=[];
if(!$.isArray(_cda)){
_cda=$.map(String(_cda).split(opts.separator),function(v){
return parseFloat(v);
});
}
_cdc.find(".slider-value").remove();
var name=$(_cd9).attr("sliderName")||"";
for(var i=0;i<_cda.length;i++){
var _cdf=_cda[i];
if(_cdf<opts.min){
_cdf=opts.min;
}
...
var _ce0=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_cdc);
_ce0.attr("name",name);
_ce0.val(_cdf);
_cde.push(_cdf);
var _ce1=_cdc.find(".slider-handle:eq("+i+")");
var tip=_ce1.next();
var pos=_ce2(_cd9,_cdf);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_cd9,_cdf));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _ce3="left:"+pos+"px;";
_ce1.attr("style",_ce3);
tip.attr("style",_ce3+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _ce3="top:"+pos+"px;";
_ce1.attr("style",_ce3);
tip.attr("style",_ce3+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_cde:_cde[0];
$(_cd9).val(opts.range?_cde.join(opts.separator):_cde[0]);
if(_cdd.join(",")!=_cde.join(",")){
opts.onChange.call(_cd9,opts.value,(opts.range?_cdd:_cdd[0]));
}
};
function _cc3(_ce4){
var opts=$.data(_ce4,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_cd8(_ce4,opts.value);
opts.onChange=fn;
};
function _ce2(_ce5,_ce6){
var _ce7=$.data(_ce5,"slider");
var opts=_ce7.options;
var _ce8=_ce7.slider;
var size=opts.mode=="h"?_ce8.width():_ce8.height();
var pos=opts.converter.toPosition.call(_ce5,_ce6,size);
if(opts.mode=="v"){
pos=_ce8.height()-pos;
}
if(opts.reversed){
...
function _cd6(_ce9,pos){
var _cea=$.data(_ce9,"slider");
var opts=_cea.options;
var _ceb=_cea.slider;
var size=opts.mode=="h"?_ceb.width():_ceb.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _cec=opts.converter.toValue.call(_ce9,pos,size);
return _cec;
};
$.fn.slider=function(_ced,_cee){
if(typeof _ced=="string"){
return $.fn.slider.methods[_ced](this,_cee);
}
_ced=_ced||{};
return this.each(function(){
var _cef=$.data(this,"slider");
if(_cef){
$.extend(_cef.options,_ced);
}else{
_cef=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_ced),slider:init(this)});
$(this)._propAttr("disabled",false);
}
...
return jq.slider("options").value;
},setValue:function(jq,_cf1){
return jq.each(function(){
_cd8(this,[_cf1]);
});
},setValues:function(jq,_cf2){
return jq.each(function(){
_cd8(this,_cf2);
});
},clear:function(jq){
...
_cd8(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_cf3){
var t=$(_cf3);
return $.extend({},$.parser.parseOptions(_cf3,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_cf4){
return _cf4;
},converter:{toPosition:function(_cf5,size){
var opts=$(this).slider("options");
var p=(_cf5-opts.min)/(opts.max-opts.min)*size;
return p;
},toValue:function(pos,size){
var opts=$(this).slider("options");
var v=opts.min+(opts.max-opts.min)*(pos/size);
return v;
}},onChange:function(_cf6,_cf7){
},onSlideStart:function(_cf8){
},onSlideEnd:function(_cf9){
},onComplete:function(_cfa){
}};
})(jQuery);
